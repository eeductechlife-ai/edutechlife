---
name: clerk-setup
description: Configuración de autenticación Clerk. Implementación de login, signup, protección de rutas, y migración desde otros sistemas de auth para proyectos web.
license: MIT
