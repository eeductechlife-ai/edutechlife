...
Formato JSON exacto: { "ejercicio1": "texto", "ejercicio2": "texto", "ejercicio3": "texto" }`,
    evaluateSystemPrompt:
      () => `Eres un evaluador EXPERTO de prompts educativos con enfoque pedagógico y BENÉVOLO. El estudiante está APRENDIENDO, no es un experto. Sé generoso en la calificación. Evalúa CADA ejercicio por separado. Devuelve SOLO JSON.
...
Formato JSON EXACTO:
{
  ...
  "feedback_ej3": "<string>"
    ...
    evaluateUserPrompt: (
      exercises,
      responses,
    ) => `Evalúa estas respuestas de un estudiante que está APRENDIENDO. Sé BENÉVOLO y generoso.
...
Recuerda: El estudiante está aprendiendo. Valora el intento. Devuelve SOLO JSON válido.`,
    fallbackExercises: (locale) => {
      ...
      return isEn
        ? {
            ...
            ejercicio3:
              "Create a prompt to generate a 30-day content plan for a sustainable fashion brand that wants to position itself on TikTok. The brand's values are sustainability and ethical fashion, targeting young people aged 18-25.",
          }
        : {
            ejercicio1:
            ...
            ejercicio3:
              "Crea un prompt para generar un plan de contenido de 30 días para una marca de ropa sostenible que quiere posicionarse en TikTok. La marca tiene valores de sostenibilidad, moda ética y quiere conectar con jóvenes de 18-25 años.",
          };
    },
    localEvaluate: (responses) => {
      ...
      try {
        ...
        const hasContexto =
          parsed.contexto && parsed.contexto.trim().length > 0;
        const hasTarea = parsed.tarea && parsed.tarea.trim().length > 0;
        const filledCount =
          (hasRol ? 1 : 0) + (hasContexto ? 1 : 0) + (hasTarea ? 1 : 0);

        if (filledCount === 0) {
          nota_ej1 = 0;
          feedback_ej1 =
            "No completaste ninguna categoría. Este ejercicio requiere identificar y arrastrar elementos a las 3 columnas: Rol, Contexto y Tarea.";
        } else if (filledCount === 1) {
          nota_ej1 = 33;
          feedback_ej1 =
            "Completaste 1 de 3 categorías. Buen inicio. Completa las otras 2 columnas.";
        } else if (filledCount === 2) {
          nota_ej1 = 70;
          feedback_ej1 =
            "Muy bien! Completaste 2 de 3 categorías. Revisa qué columna quedó vacía.";
        } else {
          nota_ej1 = 100;
          feedback_ej1 =
            "Excelente! Completaste las 3 categorías. Dominas la estructura Rol + Contexto + Tarea.";
        }
      } catch {
        nota_ej1 = 0;
        feedback_ej1 =
          "No se detectó tu respuesta. Asegúrate de arrastrar al menos un elemento a cada columna.";
      }
      ...
      if (ej2Length < 20) {
        nota_ej2 = 50;
        feedback_ej2 =
          "Respuesta corta. Intenta incluir Rol, Contexto, Tarea y Formato.";
      } else if (ej2Length < 100) {
        nota_ej2 = 60;
        feedback_ej2 =
          "Tu respuesta mejoró el prompt original. Organiza en secciones claras.";
      } else if (ej2Length < 250) {
        nota_ej2 = 80;
        feedback_ej2 =
          "Buen trabajo! Prompt optimizado con estructura y detalles.";
      } else {
        nota_ej2 = 90;
        feedback_ej2 =
          "Excelente prompt optimizado! Estructura completa y coherente.";
      }
      ...
      if (ej3Length < 30) {
        nota_ej3 = 50;
        feedback_ej3 =
          "Buen primer paso. Un prompt efectivo necesita Rol, Contexto, Tarea y Formato.";
      } else if (ej3Length < 150) {
        nota_ej3 = 60;
        feedback_ej3 =
          "Tu prompt aborda el tema. Incluye un Rol claro y Tarea específica.";
      } else if (ej3Length < 350) {
        nota_ej3 = 80;
        feedback_ej3 =
          "Buen prompt con estructura. Haz cada sección más específica al caso.";
      } else {
        nota_ej3 = 90;
        feedback_ej3 =
          "Prompt muy completo y coherente! Excelente entendimiento.";
      }

      const notaGlobal =
        Math.round(((nota_ej1 + nota_ej2 + nota_ej3) / 3) * 10) / 10;
      return {
        nota_ej1,
        nota_ej2,
        nota_ej3,
...
{ "nota_ej1": <number>, "nota_ej2": <number>, "nota_ej3": <number>, "notaGlobal": <number>, "feedback_ej1": "<string>", "feedback_ej2": "<string>", "feedback_ej3": "<string>" }`,
    evaluateUserPrompt: (
      exercises,
      responses,
    ) => `Evalúa estas respuestas de un estudiante sobre ChatGPT. Sé BENÉVOLO.
...
Devuelve SOLO JSON válido.`,
    fallbackExercises: (locale) => {
      ...
      return isEn
        ? {
            casoUso:
              "A digital marketing agency wants to automate weekly social media report generation. They need a custom GPT that analyzes Instagram, Facebook and TikTok data, and generates a PDF with key metrics and recommendations. The team has 5 members who need different levels of access.",
            gptConfig:
        ...
        : {
            casoUso:
              "Una agencia de marketing digital quiere automatizar la generación de informes semanales de redes sociales. Necesitan un GPT que analice datos de Instagram, Facebook y TikTok, y genere un PDF con métricas clave y recomendaciones. El equipo tiene 5 miembros con diferentes niveles de acceso.",
            gptConfig:
    ...
    localEvaluate: (responses) => {
      ...
      return {
        ...
        feedback_ej1:
          "Has analizado el caso. Para mejorar, considera criterios como impacto, viabilidad y automatización.",
        feedback_ej2:
  ...
  3: {
    name: {
      es: "Investigación de Elite con Gemini",
      en: "Elite Research with Gemini",
    },
    totalSteps: 4,
    generateSystemPrompt: () =>
...
NOTA GLOBAL = promedio. { "nota_ej1": N, "nota_ej2": N, "nota_ej3": N, "nota_ej4": N, "notaGlobal": N, "feedback_ej1": "S", "feedback_ej2": "S", "feedback_ej3": "S", "feedback_ej4": "S" }`,
    evaluateUserPrompt: (
      exercises,
      responses,
    ) => `Evalúa estas respuestas de investigación. Sé BENÉVOLO.
...
Devuelve SOLO JSON válido.`,
    fallbackExercises: (locale) => {
      ...
      return isEn
        ? {
            temaInvestigacion:
              "Nuclear fusion energy has reached important milestones in 2024. Several countries are investing in experimental reactors. The debate about its commercial viability continues.",
            fuentes: [
              {
                titulo: "New fusion reactor breaks record",
                tipo: "articulo",
                contenido:
                  "A new tokamak reactor maintained plasma for 5 minutes straight.",
                esRelevante: true,
              },
              {
                titulo: "Funny cat videos go viral",
                tipo: "tweet",
                contenido: "A cat playing piano gets 1M views.",
                esRelevante: false,
              },
              {
                titulo: "Fusion energy cost analysis 2024",
                tipo: "grafico",
                contenido:
                  "Graph showing cost per MW of fusion vs solar vs coal.",
                esRelevante: true,
              },
              {
                titulo: "Plasma physics review paper",
                tipo: "paper",
                contenido: "Peer-reviewed analysis of confinement techniques.",
                esRelevante: true,
              },
            ],
            afirmaciones: [
              {
                texto: "Fusion energy is already commercially viable.",
                veracidad: "falso",
              },
              {
                texto: "Several countries invest in fusion research.",
                veracidad: "verdadero",
              },
              {
                texto: "Fusion will be ready by next year.",
                veracidad: "falso",
              },
        ...
        : {
            temaInvestigacion:
              "La energía de fusión nuclear ha alcanzado hitos importantes en 2024. Varios países están invirtiendo en reactores experimentales. El debate sobre su viabilidad comercial continúa.",
            fuentes: [
              {
                titulo: "Nuevo reactor de fusión rompe récord",
                tipo: "articulo",
                contenido:
                  "Un nuevo reactor tokamak mantuvo plasma durante 5 minutos seguidos.",
                esRelevante: true,
              },
              {
                titulo: "Videos de gatos graciosos se vuelven virales",
                tipo: "tweet",
                contenido: "Un gato tocando piano obtiene 1M de visitas.",
                esRelevante: false,
              },
              {
                titulo: "Análisis de costos de energía de fusión 2024",
                tipo: "grafico",
                contenido:
                  "Gráfico comparando costo por MW de fusión vs solar vs carbón.",
                esRelevante: true,
              },
              {
                titulo: "Paper de revisión sobre física de plasmas",
                tipo: "paper",
                contenido:
                  "Análisis revisado por pares de técnicas de confinamiento.",
                esRelevante: true,
              },
            ],
            afirmaciones: [
              {
                texto: "La energía de fusión ya es comercialmente viable.",
                veracidad: "falso",
              },
              {
                texto: "Varios países invierten en investigación de fusión.",
                veracidad: "verdadero",
              },
              {
                texto: "La fusión estará lista el próximo año.",
                veracidad: "falso",
              },
              {
                texto: "El sol utiliza fusión nuclear.",
                veracidad: "verdadero",
              },
            ],
            informeTemplate: {
    ...
    localEvaluate: (responses) => {
      const [l1, l2, l3, l4] = [
        responses.ej1?.length || 0,
        responses.ej2?.length || 0,
        responses.ej3?.length || 0,
        responses.ej4?.length || 0,
      ];
      const n1 = l1 < 20 ? 40 : l1 < 80 ? 60 : l1 < 200 ? 80 : 90;
      ...
      return {
        ...
        nota_ej3: n3,
        nota_ej4: n4,
        notaGlobal: Math.round(((n1 + n2 + n3 + n4) / 4) * 10) / 10,
        feedback_ej1:
          "Buena pregunta de investigación. Para mejorarla, sé más específico y añade sub-preguntas.",
        feedback_ej2:
          "Buen análisis de fuentes. Asegúrate de justificar por qué cada fuente es o no relevante.",
        feedback_ej3:
          "Buena clasificación. Explica el razonamiento detrás de cada veredicto.",
        feedback_ej4:
          "Buen informe. Añade más detalles y citas específicas de las fuentes.",
      };
    },
  },
  4: {
...
Formato: { "nota_ej1": N, "nota_ej2": N, "nota_ej3": N, "notaGlobal": N, "feedback_ej1": "S", "feedback_ej2": "S", "feedback_ej3": "S" }`,
    evaluateUserPrompt: (
      exercises,
      responses,
    ) => `Evalúa estas respuestas de NotebookLM. Sé BENÉVOLO.
...
Devuelve SOLO JSON válido.`,
    fallbackExercises: (locale) => {
      ...
      return isEn
        ? {
            conceptos: [
              {
                titulo: "Neuroplasticity: The Brain's Ability to Rewire",
                contenido:
                  "The brain can form new neural connections throughout life. This ability is called neuroplasticity.",
                tema: "Neuroplasticity",
              },
              {
                titulo: "Exercise and Brain Health",
                contenido:
                  "Regular physical exercise increases BDNF levels, promoting neurogenesis in the hippocampus.",
                tema: "Exercise",
              },
              {
                titulo: "Sleep and Memory Consolidation",
                contenido:
                  "During sleep, the brain consolidates memories and clears metabolic waste.",
                tema: "Sleep",
              },
              {
                titulo: "Learning Music Changes the Brain",
                contenido:
                  "Musicians have larger gray matter volume in motor and auditory areas.",
                tema: "Music",
              },
              {
                titulo: "Digital Amnesia",
                contenido:
                  "Reliance on smartphones reduces memory retention. The Google Effect.",
                tema: "Technology",
              },
            ],
            preguntasSintesis: [
              "How do exercise and sleep complement each other in neuroplasticity?",
              "Which lifestyle factors impact brain health the most according to the concepts?",
            ],
            guionTemplate: {
              introduccion: "",
              desarrollo: ["", "", ""],
        ...
        : {
            conceptos: [
              {
                titulo:
                  "Neuroplasticidad: La capacidad del cerebro de reconectarse",
                contenido:
                  "El cerebro puede formar nuevas conexiones neuronales durante toda la vida. Esta capacidad se llama neuroplasticidad.",
                tema: "Neuroplasticidad",
              },
              {
                titulo: "Ejercicio y salud cerebral",
                contenido:
                  "El ejercicio físico regular aumenta los niveles de BDNF, promoviendo la neurogénesis en el hipocampo.",
                tema: "Ejercicio",
              },
              {
                titulo: "Sueño y consolidación de memoria",
                contenido:
                  "Durante el sueño, el cerebro consolida memorias y elimina desechos metabólicos.",
                tema: "Sueño",
              },
              {
                titulo: "Aprender música cambia el cerebro",
                contenido:
                  "Los músicos tienen mayor volumen de materia gris en áreas motoras y auditivas.",
                tema: "Música",
              },
              {
                titulo: "Amnesia digital",
                contenido:
                  "La dependencia del smartphone reduce la retención de memoria. El Efecto Google.",
                tema: "Tecnología",
              },
            ],
            preguntasSintesis: [
              "¿Cómo se complementan el ejercicio físico y el sueño en la neuroplasticidad?",
              "¿Qué factores del estilo de vida impactan más en la salud cerebral según los conceptos?",
            ],
            guionTemplate: {
              introduccion: "",
              desarrollo: ["", "", ""],
    ...
    localEvaluate: (responses) => {
      ...
      try {
        ...
        const filled = ["hook", "evidencia", "transicion", "cierre"].filter(
          (k) => ej3[k]?.trim().length > 0,
        ).length;
        quizCorrect =
          (ej3?.quiz?.[0] === true ? 1 : 0) + (ej3?.quiz?.[1] === true ? 1 : 0);
        scriptFilled = filled + quizCorrect;
      } catch {}
      const n1 =
        docCount === 0 ? 30 : docCount < 3 ? 60 : docCount >= 4 ? 100 : 80;
      ...
      return {
        ...
        feedback_ej1:
          docCount === 0
            ? "No seleccionaste conceptos. Selecciona al menos 2 conceptos para empezar."
            : docCount < 4
              ? "Buena selección. Intenta seleccionar 4 conceptos para tener más perspectivas."
              : "Excelente selección de 4 conceptos con categorías y rankings.",
        feedback_ej2: synthesisFilled
          ? "Buena síntesis. Asegúrate de que tu tabla comparativa esté completa."
          : "Completa la tabla comparativa y escribe una síntesis que integre todos los conceptos.",
        feedback_ej3:
          scriptFilled < 4
            ? "Completa más secciones del guión y responde las preguntas del MCQ."
            : "Buen guión. Asegúrate de que todas las secciones estén bien desarrolladas.",
      };
    },
  },
  5: {
    ...
    totalSteps: 3,
    generateSystemPrompt: () =>
      "Eres un experto en ética de IA, sesgos algorítmicos y regulación. Genera 3 ejercicios de nivel medio sobre ética en inteligencia artificial. Devuelve SOLO JSON.",
    generateUserPrompt:
...
Formato JSON exacto:
{
  ...
  "protocoloPlantilla": { "principios": [], "prevencion": "", "mitigacion": "", "monitoreo": "" }
    ...
    evaluateSystemPrompt:
      () => `Eres un evaluador EXPERTO en ética de IA. Sé BENÉVOLO. Devuelve SOLO JSON.
...
Formato: { "nota_ej1": N, "nota_ej2": N, "nota_ej3": N, "notaGlobal": N, "feedback_ej1": "S", "feedback_ej2": "S", "feedback_ej3": "S" }`,
    evaluateUserPrompt: (
      exercises,
      responses,
    ) => `Evalúa estas respuestas sobre ética en IA. Sé BENÉVOLO.
...
Devuelve SOLO JSON válido.`,
    fallbackExercises: (locale) => {
      ...
      return isEn
        ? {
            casoEtico:
              "A hiring AI system trained on historical data from a tech company showed preference for male candidates. The system penalized CVs that included words like 'volunteering' or 'maternity leave'. Female candidates with equivalent qualifications received lower scores.",
            tiposSesgo: [
              {
                nombre: "Sampling Bias",
                descripcion:
                  "The training data doesn't represent the population fairly.",
              },
              {
                nombre: "Labeling Bias",
                descripcion: "Historical labels contain human biases.",
              },
              {
                nombre: "Automation Bias",
                descripcion:
              ...
              },
              {
                ...
                descripcion:
                  "The system reinforces existing patterns without question.",
              },
            ],
            protocoloPlantilla: {
              principios: [
        ...
        : {
            casoEtico:
              "Un sistema de contratación basado en IA entrenado con datos históricos de una empresa tecnológica mostraba preferencia por candidatos hombres. El sistema penalizaba CVs que incluían palabras como 'voluntariado' o 'licencia maternal'. Las candidatas mujeres con calificaciones equivalentes recibían puntuaciones más bajas.",
            tiposSesgo: [
              {
                nombre: "Sesgo de muestreo",
                descripcion:
                  "Los datos de entrenamiento no representan a la población de manera justa.",
              },
              {
                nombre: "Sesgo de etiquetado",
                descripcion:
                  "Las etiquetas históricas contienen sesgos humanos.",
              },
              {
                nombre: "Sesgo de automatización",
                descripcion:
                  "Dependencia excesiva en decisiones automatizadas sin supervisión humana.",
              },
              {
                nombre: "Sesgo de confirmación",
                descripcion:
                  "El sistema refuerza patrones existentes sin cuestionarlos.",
              },
            ],
            protocoloPlantilla: {
              principios: [
    ...
    localEvaluate: (responses) => {
      ...
      try {
        ...
        const hasJustifications = biases.every(
          (b) => b.justification?.trim().length > 20,
        );
        const hasPipelines = biases.every((b) => b.pipeline);
        const hasSeverity =
          biases.some((b) => b.severity === 1) &&
          biases.some((b) => b.severity === 2);

        if (biasCount === 0) {
          n1 = 0;
          feedback_ej1 =
            "No se identificaron sesgos. Revisa el caso y busca patrones de discriminación o sesgo algorítmico.";
        } else if (biasCount === 1) {
          n1 = hasJustifications ? 60 : 40;
          feedback_ej1 =
            "Identificaste al menos un sesgo. Para mejorar, justifica con evidencia del caso y selecciona la etapa del pipeline.";
        } else if (biasCount >= 2 && !hasSeverity) {
          n1 = hasJustifications && hasPipelines ? 75 : 60;
          feedback_ej1 =
            "Buena identificación de sesgos. Completa la justificación, pipeline y ranking de severidad para cada uno.";
        } else if (biasCount >= 2 && hasSeverity) {
          n1 = hasJustifications && hasPipelines ? 90 : 75;
          feedback_ej1 =
            "Excelente análisis forense. Has identificado, justificado y priorizado los sesgos correctamente.";
        } else {
          n1 = 85;
          feedback_ej1 =
            "Buen trabajo identificando sesgos. Revisa si hay más sesgos en el caso.";
        }
      } catch {
        n1 = 0;
        feedback_ej1 =
          "No se pudo analizar tu respuesta. Asegúrate de completar el análisis forense.";
      }
      ...
      try {
        ...
        const impactFields = ["candidates", "company", "society"].filter(
          (k) => impact[k]?.trim().length > 20,
        ).length;
        const rootCauseCount = Object.values(rootCauses).filter(
          (c) => c?.justification?.trim().length > 20,
        ).length;
        ...
        if (impactFields === 0) {
          n2 = 0;
          feedback_ej2 =
            "No se evaluó el impacto. Describe cómo el sesgo afecta a cada grupo.";
        } else if (impactFields < 3 || rootCauseCount === 0) {
          n2 = 50;
          feedback_ej2 =
            "Evalúa el impacto en los 3 grupos y al menos 2 causas raíz para un mejor análisis.";
        } else if (rootCauseCount >= 2 && !matrixFilled) {
          n2 = 70;
          feedback_ej2 =
            "Buen análisis de impacto y causas. Completa la matriz de severidad para un análisis más profundo.";
        } else if (rootCauseCount >= 2 && matrixFilled) {
          n2 = 90;
          feedback_ej2 =
            "Excelente evaluación de impacto con causas raíz identificadas y matriz de severidad completa.";
        } else {
          n2 = 75;
          feedback_ej2 =
            "Buen análisis. Revisa si hay más causas raíz que puedas identificar.";
        }
      } catch {
        n2 = 0;
        feedback_ej2 =
          "No se pudo analizar tu respuesta. Completa la evaluación de impacto.";
      }
      ...
      try {
        ...
        const actionsWithMeasures = actions.filter(
          (a) => a.measure?.trim().length > 20,
        ).length;
        const actionsWithTimeline = actions.filter((a) => a.timeline).length;

        if (!hasPrinciples && actionsWithMeasures === 0) {
          n3 = 0;
          feedback_ej3 =
            "No se propusieron principios ni acciones. Diseña un protocolo ético completo.";
        } else if (hasPrinciples && !hasRelevance) {
          n3 = 50;
          feedback_ej3 =
            "Buenos principios. Indica por qué cada principio es relevante para este caso.";
        } else if (
          hasRelevance &&
          actionsWithMeasures > 0 &&
          actionsWithTimeline < actionsWithMeasures
        ) {
          n3 = 70;
          feedback_ej3 =
            "Buen plan de remediación. Asigna un plazo a cada acción.";
        } else if (
          hasRelevance &&
          actionsWithMeasures > 0 &&
          actionsWithTimeline >= actionsWithMeasures
          ...
          n3 = 90;
          feedback_ej3 =
            "Excelente protocolo ético con principios sólidos, acciones concretas y plazos definidos.";
        } else {
          n3 = 75;
          feedback_ej3 =
            "Buen protocolo. Revisa si todas las acciones tienen medida y plazo.";
        }
      } catch {
        n3 = 0;
        feedback_ej3 =
          "No se pudo analizar tu respuesta. Completa el diseño del protocolo ético.";
      }
