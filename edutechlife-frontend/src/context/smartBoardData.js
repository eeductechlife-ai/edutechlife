export const DEFAULT_NEWS = [
  { id: 1, title: '¿Sabías que la IA puede ayudarte a estudiar?', summary: 'La inteligencia artificial está cambiando la forma en que aprendemos. ¡Descubre cómo!', category: 'IA', ageRange: '8-16', date: '2026-05-04', readTime: '2 min', icon: '🤖' },
  { id: 2, title: 'Nuevas herramientas STEAM para tu colegio', summary: 'Proyectos de ciencia, tecnología, ingeniería, arte y matemáticas que puedes hacer en casa.', category: 'STEAM', ageRange: '8-16', date: '2026-05-03', readTime: '3 min', icon: '🔬' },
  { id: 3, title: 'Consejos de Dani: Cómo organizar tu tiempo', summary: 'Tips sencillos para que cumplas con tus tareas y tengas tiempo para jugar.', category: 'Tips', ageRange: '8-16', date: '2026-05-02', readTime: '2 min', icon: '⏰' },
]
