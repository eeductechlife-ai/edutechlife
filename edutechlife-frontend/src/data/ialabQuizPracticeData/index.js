...
export const MODULE_QUIZ_PRACTICE = {
  1: MODULE_1,
  2: MODULE_2,
  3: MODULE_3,
  4: MODULE_4,
...
export const MODULE_QUIZ_PRACTICE_EN = {
  1: MODULE_1_EN,
  2: MODULE_2_EN,
  3: MODULE_3_EN,
  4: MODULE_4_EN,
...
export const MODULE_QUIZ_PRACTICE_PT = {
  1: MODULE_1_PT,
  2: MODULE_2_PT,
  3: MODULE_3_PT,
  4: MODULE_4_PT,
...
export function getQuizPracticeData(locale) {
  if (locale && locale.startsWith("pt")) {
    return MODULE_QUIZ_PRACTICE_PT;
  }
  if (locale && locale.startsWith("en")) {
    return MODULE_QUIZ_PRACTICE_EN;
  }
  return MODULE_QUIZ_PRACTICE;
}
