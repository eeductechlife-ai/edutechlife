...
export const modules = [
  ...
  { id: 5, title: 'Proyecto Disruptivo', icon: 'fa-trophy', color: '#FFD166', topics: ['Integración Total', 'MVP Inteligente', 'Pitch Deck IA', 'Roadmap Estratégico'], challenge: 'Analiza un caso real de sesgo algorítmico en IA y propón un protocolo ético para prevenir y mitigar este tipo de discriminación.', desc: 'Llegó el momento de unir todo. Vas a integrar todas las herramientas IA en un proyecto real: desde crear un MVP hasta presentarlo como un profesional.', duration: '2h', level: 'Experto', videos: 6, projects: 5 },
];
