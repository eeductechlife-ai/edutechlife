export const learningObjectives = [
  "Simular el uso de NotebookLM para organizar información",
  "Practicar la carga y análisis de documentos en un entorno virtual",
  "Desarrollar habilidades de síntesis de información con IA",
  "Evaluar la calidad de las respuestas basadas en fuentes propias",
];
...
export const furtherReading = [
  {
    ...
    description: "Centro de ayuda oficial de NotebookLM.",
  },
  {
    title: "AI-Powered Research Tools Comparison",
    url: "https://www.edutechlife.com/blog/ai-research-tools",
    description: "Comparativa de herramientas de investigación con IA.",
  },
];
...
export const contentScreens = [
  {
    ...
    example: {
      weak: "Descargar 30 PDFs sobre IA sin leer títulos ni autores",
      strong:
        "Seleccionar 8 papers revisados por pares, organizados por tema: 3 de ética, 3 de técnicos, 2 de aplicaciones prácticas",
    },
    image:
  ...
  },
  {
    ...
    example: {
      weak: "Resumir cada paper por separado sin relacionarlos entre sí",
      strong:
        "Crear una matriz comparativa que muestre coincidencias y divergencias entre 5 autores sobre el mismo tema, con citas textuales de respaldo",
    },
    image:
  ...
  },
  {
    ...
    example: {
      weak: "Aceptar como verdad absoluta un estudio con muestra de 20 personas",
      strong:
        "Analizar críticamente: identificar el tamaño muestral, metodología, posibles sesgos y limitaciones antes de extraer conclusiones",
    },
    image:
...
export const questionsData = [
  {
    ...
    image:
      "https://images.unsplash.com/photo-1555949963-ff9fe0c870eb?auto=format&fit=crop&q=80&w=1000",
    question:
      "¿Cuál es el primer paso recomendado antes de subir documentos a NotebookLM para análisis?",
    options: [
    ...
    correct: 1,
    explanation:
      "Correcto. La curaduría de fuentes es fundamental. Debes seleccionar documentos relevantes, confiables y actualizados antes de subirlos a tu notebook.",
  ...
  },
  {
    ...
    correct: 1,
    explanation:
      "Exacto. La síntesis cruzada te permite conectar ideas entre distintos documentos, identificar dónde coinciden los autores y dónde existen divergencias.",
  ...
  },
  {
    ...
    question:
      "¿Qué debes hacer si encuentras dos fuentes que se contradicen en tu investigación?",
    options: [
    ...
    correct: 2,
    explanation:
      "¡Excelente! Las contradicciones son oportunidades de aprendizaje. Debes analizar por qué discrepan, considerando metodologías, contextos y fechas.",
  ...
  },
  {
    ...
    correct: 1,
    explanation:
      "Correcto. Organizar tus fuentes por temas o categorías te permite hacer preguntas más precisas y obtener respuestas más relevantes de la IA.",
  ...
  },
  {
    ...
    question:
      "¿Por qué es importante verificar las citas que proporciona NotebookLM?",
    options: [
    ...
    correct: 0,
    explanation:
      "¡Muy bien! Aunque NotebookLM es muy preciso al citar, siempre debes verificar que la cita corresponda al contexto correcto dentro del documento original.",
  ...
  },
  {
    ...
    question:
      "¿Qué estrategia es más efectiva al hacer preguntas a NotebookLM sobre múltiples fuentes?",
    options: [
    ...
    correct: 1,
    explanation:
      "Correcto. Las preguntas específicas que requieren comparación entre fuentes aprovechan al máximo la capacidad de NotebookLM para hacer síntesis cruzadas.",
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1456324504439-367cee3b3c32?auto=format&fit=crop&q=80&w=1000",
    question:
      "¿Cuál es el beneficio principal de usar NotebookLM para análisis documental?",
    options: [
    ...
    correct: 1,
    explanation:
      "¡Exacto! NotebookLM es un asistente que amplifica tu capacidad de análisis, permitiéndote trabajar con múltiples fuentes a la vez, pero siempre requiere tu supervisión y pensamiento crítico.",
