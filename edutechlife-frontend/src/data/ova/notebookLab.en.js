export const learningObjectives = [
  "Understand the concept of AI based on your own sources",
  "Learn to create and manage notebooks in NotebookLM",
  "Differentiate NotebookLM from traditional chatbots",
  "Apply research strategies with your own documents",
];
...
export const furtherReading = [
  {
    ...
    description: "Google's official NotebookLM platform.",
  },
  {
    title: "How to Use NotebookLM for Research",
    url: "https://blog.google/technology/ai/notebooklm/",
    description: "Official Google guide on using NotebookLM.",
  },
];
...
export const contentScreens = [
  ...
  },
  {
    ...
    example: {
      weak: "Upload everything I find about AI without any criteria",
      strong:
        "10 papers selected by relevance, organized by topic (ethics, technical, applications), with context notes for each group",
    },
    image:
  ...
  },
  {
    ...
    example: {
      weak: "Vague and generic conversation about the topic with no depth",
      strong:
        "15-minute podcast where two hosts discuss key findings from 5 papers on neuroplasticity, with practical examples and clear analogies",
    },
    image:
...
export const questionsData = [
  {
    ...
    correct: 1,
    explanation:
      "Correct! NotebookLM stands out because it only uses the information you upload. This ensures it doesn't make up data that isn't in your notes.",
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1507146153580-69a1fe6d8aa1?auto=format&fit=crop&q=80&w=1000",
    question:
      "What is the most important difference between using ChatGPT and NotebookLM for studying?",
    options: [
    ...
    correct: 0,
    explanation:
      "Exactly. While ChatGPT has general knowledge from across the web, NotebookLM focuses on being super precise and strict only with the documents you chose.",
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1550751827-4bd374c3f58b?auto=format&fit=crop&q=80&w=1000",
    question:
      "What amazing feature does NotebookLM have to help you 'listen' to your documents?",
    options: [
    ...
    correct: 3,
    explanation:
      "Very good! The 'Audio Overview' tool creates a very realistic podcast simulation where two hosts discuss your notes, ideal for studying while listening.",
  ...
  },
  {
    ...
    question:
      "NotebookLM is said to be 'hallucination-free'. What does this mean?",
    options: [
    ...
    correct: 2,
    explanation:
      "Correct. Since the AI is restricted only to your PDFs or documents, the risk of it making up false information (hallucination) is almost completely eliminated.",
  ...
  },
  {
    ...
    question:
      "If you're doing a group project for school or university, can you use NotebookLM with your classmates?",
    options: [
    ...
    correct: 1,
    explanation:
      "That's right! You can collaborate as a team. Everyone can read the same notebook, ask questions from the same sources, and listen to the same generated podcast.",
  ...
  },
  {
    ...
    question:
      "According to the guide's 'Best Practices', what should you ALWAYS do when NotebookLM gives you an answer?",
    options: [
    ...
    correct: 0,
    explanation:
      "Excellent. NotebookLM is a great assistant, but you are the student. You should always verify by clicking the citations to see which part of the original text the idea came from.",
  ...
  },
  {
    ...
    question:
      "According to the manual, how many different documents or sources can you upload to a single notebook in NotebookLM?",
    options: [
    ...
    correct: 3,
    explanation:
      "Correct. You can feed your notebook with up to 50 different sources (like PDFs, documents, links, etc.) so the AI can cross-reference information between all of them.",
