...
export const contentScreens = [
  {
    ...
    example: {
      weak: "Download 30 PDFs about AI without reading titles or authors",
      strong:
        "Select 8 peer-reviewed papers, organized by topic: 3 on ethics, 3 technical, 2 on practical applications",
    },
    image:
  ...
  },
  {
    ...
    example: {
      weak: "Summarizing each paper separately without relating them to each other",
      strong:
        "Create a comparative matrix showing coincidences and divergences between 5 authors on the same topic, with supporting verbatim citations",
    },
    image:
  ...
  },
  {
    ...
    example: {
      weak: "Accepting as absolute truth a study with a 20-person sample",
      strong:
        "Critically analyze: identify sample size, methodology, potential biases, and limitations before drawing conclusions",
    },
    image:
...
export const questionsData = [
  {
    ...
    image:
      "https://images.unsplash.com/photo-1555949963-ff9fe0c870eb?auto=format&fit=crop&q=80&w=1000",
    question:
      "What is the first recommended step before uploading documents to NotebookLM for analysis?",
    options: [
    ...
    correct: 1,
    explanation:
      "Correct. Source curation is essential. You should select relevant, reliable, and up-to-date documents before uploading them to your notebook.",
  ...
  },
  {
    ...
    correct: 1,
    explanation:
      "Exactly. Cross-synthesis lets you connect ideas across different documents, identifying where authors agree and where there are divergences.",
  ...
  },
  {
    ...
    question:
      "What should you do if you find two sources that contradict each other in your research?",
    options: [
    ...
    correct: 2,
    explanation:
      "Excellent! Contradictions are learning opportunities. You should analyze why they disagree, considering methodologies, contexts, and dates.",
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1516321318423-f06f85e504b3?auto=format&fit=crop&q=80&w=1000",
    question:
      "What is the best practice when organizing sources in NotebookLM?",
    options: [
    ...
    correct: 1,
    explanation:
      "Correct. Organizing your sources by topics or categories allows you to ask more precise questions and get more relevant answers from the AI.",
  ...
  },
  {
    ...
    question:
      "Why is it important to verify the citations provided by NotebookLM?",
    options: [
    ...
    correct: 0,
    explanation:
      "Very good! Although NotebookLM is very precise with citations, you should always verify that the citation matches the correct context within the original document.",
  ...
  },
  {
    ...
    question:
      "What strategy is most effective when asking NotebookLM questions about multiple sources?",
    options: [
    ...
    correct: 1,
    explanation:
      "Correct. Specific questions that require comparison across sources make the most of NotebookLM's ability to perform cross-synthesis.",
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1456324504439-367cee3b3c32?auto=format&fit=crop&q=80&w=1000",
    question:
      "What is the main benefit of using NotebookLM for document analysis?",
    options: [
    ...
    correct: 1,
    explanation:
      "Exactly! NotebookLM is an assistant that amplifies your analysis capabilities, allowing you to work with multiple sources at once, but it still requires your supervision and critical thinking.",
