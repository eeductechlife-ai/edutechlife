export const infographicData = {
  ...
  sections: [
    {
      id: "evolution", title: "Evolución del Motor de IA (Modelos GPT)", icon: "TrendingUp",
    ...
    {
      id: "modes", title: "Modos de Operación", icon: "Cpu",
    ...
    {
      id: "tools", title: "La Caja de Herramientas Integrada", icon: "Wrench",
    ...
    {
      id: "automation", title: "Conectividad y Automatización", icon: "Share2",
