export const challenges = [
  {
    ...
    scenario:
      "Eres consultor de negocio y tu cliente te pide un análisis competitivo del mercado de vehículos eléctricos en Latinoamérica para 2025. Necesitas datos actualizados, tendencias y proyecciones. ¿Cuál es la mejor estrategia usando Gemini?",
    context:
    ...
    correct: 1,
    feedback:
      "Deep Research es ideal para este caso: busca activamente en la web, cruza fuentes y entrega un informe con citas verificables. Los datos de entrenamiento pueden estar desactualizados y la búsqueda manual es ineficiente.",
  ...
  },
  {
    ...
    scenario:
      "Recibes un contrato de 45 páginas en PDF con términos complejos. Debes identificar cláusulas riesgosas, fechas clave y obligaciones antes de una reunión en 2 horas. ¿Cómo usas Gemini para maximizar tu tiempo?",
    context:
    ...
    correct: 1,
    feedback:
      "Gemini puede procesar documentos extensos en segundos. Subir el PDF y hacer preguntas dirigidas te permite extraer la información crítica en minutos, no horas.",
  ...
  },
  {
    ...
    scenario:
      "Eres líder de proyecto y necesitas enviar un informe de avance semanal a 15 stakeholders, cada uno con datos personalizados según su departamento. Tienes los datos en una hoja de Sheets. ¿Cuál es el flujo más eficiente con Gemini en Google Workspace?",
    context:
    ...
    correct: 1,
    feedback:
      "La integración de Gemini en Workspace permite un flujo continuo: analiza en Sheets, redacta en Docs y personaliza en Gmail sin salir del ecosistema. Esto ahorra horas de trabajo repetitivo.",
  ...
  },
  {
    ...
    scenario:
      "Tu equipo de marketing recibió 50 capturas de pantalla de la competencia mostrando sus nuevas campañas. Necesitas un análisis visual rápido de tendencias: colores, mensajes clave, formatos y CTAs. ¿Cómo aprovechas las capacidades multimodales de Gemini?",
    context:
    ...
    correct: 1,
    feedback:
      "La capacidad multimodal de Gemini analiza simultáneamente texto, colores, composición y elementos visuales. Puede identificar patrones que un análisis manual pasaría por alto y entrega resultados en segundos.",
  ...
  },
  {
    ...
    scenario:
      "Tienes un script en Python de 300 líneas que procesa datos financieros, pero está dando errores intermitentes y tarda 45 minutos en ejecutarse. Necesitas identificar bugs y optimizarlo. No eres experto en Python. ¿Cómo usas Gemini?",
    context:
    ...
    correct: 1,
    feedback:
      "Gemini puede analizar código completo, identificar errores, sugerir optimizaciones y explicar cada cambio. Es como tener un desarrollador senior disponible al instante, sin necesidad de ser experto en el lenguaje.",
  ...
  },
  {
    ...
    scenario:
      "Tienes un archivo CSV con 10,000 filas de datos de ventas del último trimestre: productos, regiones, fechas, montos y canales. Necesitas identificar tendencias, anomalías y oportunidades de crecimiento antes de la junta directiva en 3 horas. ¿Cuál es tu estrategia con Gemini?",
    context:
    ...
    correct: 1,
    feedback:
      "Gemini procesa grandes volúmenes de datos en segundos, identifica patrones que el ojo humano no detecta y entrega recomendaciones accionables. Lo que tomaría horas en Excel, Gemini lo hace en minutos.",
...
export const learningObjectives = [
  "Aplicar herramientas de IA a casos de uso profesional reales",
  "Evaluar la estrategia óptima de IA para cada escenario",
  "Desarrollar habilidades de prompt engineering para tareas específicas",
  "Integrar múltiples capacidades de IA en flujos de trabajo eficientes",
];
...
export const furtherReading = [
  {
    ...
    description: "Guía oficial de integración de Gemini en Google Workspace.",
  },
  {
    title: "Deep Research in Gemini",
    url: "https://blog.google/products/gemini/google-gemini-deep-research/",
    description:
      "Cómo usar la función Deep Research de Gemini para investigación.",
  },
];
