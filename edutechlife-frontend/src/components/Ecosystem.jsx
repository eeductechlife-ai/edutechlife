...
const Ecosystem = memo(() => {
  ...
  const cards = [
    {
      bg: "from-primary-light/20",
      border: "border-primary-light/30",
      img: "/images/eco-neuro.webp",
      titleKey: "ecosystem.card_1_title",
      descKey: "ecosystem.card_1_desc",
      delay: 0.1,
    },
    {
      bg: "from-mint/20",
      border: "border-mint/30",
      img: "/images/eco-nacional.webp",
      titleKey: "ecosystem.card_2_title",
      descKey: "ecosystem.card_2_desc",
      delay: 0.2,
    },
    {
      bg: "from-corporate/20",
      border: "border-corporate/30",
      img: "/images/edutech-carrusel-6.webp",
      titleKey: "ecosystem.card_3_title",
      descKey: "ecosystem.card_3_desc",
      delay: 0.3,
    },
  ];
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute top-[40%] left-[10%] w-2 h-2 bg-mint/50 rounded-full animate-float-3d"
        style={{ animationDelay: "-2s" }}
      />
      <div
        className="absolute bottom-[20%] right-[15%] w-4 h-4 bg-corporate/30 rounded-full animate-float-3d"
        style={{ animationDelay: "-4s" }}
      />
          ...
          {cards.map((card, i) => (
            ...
            >
              <div className="h-56 w-full overflow-hidden relative rounded-t-[20px]">
                <div
                  className={`absolute inset-0 bg-gradient-to-t ${card.bg} to-transparent z-10`}
                />
                <img
                  src={card.img}
                  alt={t(card.titleKey)}
