...
/**
 * IngenIAMetrics — Fase 4.3 Valeria Analytics
 ...
 */
const IngenIAMetrics = ({ analytics }) => {
  const {
    overview,
    subjectPerformance,
    dailySessions,
  ...
  if (isError) {
    return (
      <div className="flex flex-col items-center justify-center py-20 gap-4">
        ...
        <p className="text-[#B2D8E5]">Error al cargar analíticas IngenIA</p>
        <button
          onClick={refetch}
    ...
    <div className="space-y-8">
      ...
      <div>
        <h2 className="text-xl font-bold text-white mb-4 flex items-center gap-2">
          ...
          Resumen IngenIA — últimos {meta?.days ?? 30} días
        </h2>
