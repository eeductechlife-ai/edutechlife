  ...
  es: [
    {
      ...
      options: [
        ...
        { id: 'b', text: 'Que puede entender y procesar texto, imágenes, audio y video' },
    ...
    {
      question: '¿Cuál de las siguientes es una aplicación práctica de Gemini en Google Workspace?',
      options: [
        { id: 'a', text: 'Solo puede buscar en Google' },
        { id: 'b', text: 'Resumir hilos de correo en Gmail y generar contenido en Docs' },
    ...
    },
    {
      ...
      options: [
        ...
        { id: 'b', text: 'Analiza cientos de fuentes y genera informes estructurados con referencias verificables' },
  ...
  en: [
    {
      ...
      options: [
        ...
        { id: 'b', text: 'It can understand and process text, images, audio and video' },
    ...
    {
      question: 'Which of the following is a practical application of Gemini in Google Workspace?',
      options: [
        { id: 'a', text: 'It can only search Google' },
        { id: 'b', text: 'Summarize email threads in Gmail and generate content in Docs' },
    ...
    },
    {
      ...
      options: [
        ...
        { id: 'b', text: 'It analyzes hundreds of sources and generates structured reports with verifiable references' },
