...
const StreakCircle = ({
  ...
  >
    <motion.div
      ...
      transition={
        prefersReducedMotion
          ? {}
          : {
              repeat: filled && isToday ? Infinity : 0,
              duration: 2,
              ease: "easeInOut",
            }
      }
    ...
    <span
      className={`text-[10px] font-medium ${filled ? "text-slate-600" : "text-slate-400"}`}
    >
      {label}
    </span>
  </motion.div>
...
const StreakDetailsModal = ({ isOpen, onClose }) => {
  ...
  const tierKey =
    streak >= 7
      ? "streak.tier_imparable"
      : streak >= 3
        ? "streak.tier_encendida"
        : "streak.tier_activa";
                ...
                <div className="bg-white rounded-xl border border-slate-200/60 overflow-hidden">
                  {loadingLb ? (
                    ...
                    <div className="flex flex-col items-center py-8 text-slate-400">
                      <Icon
                        name="fa-trophy"
                        className="text-2xl mb-2 opacity-30"
                      />
                          ...
                          >
                            ...
                            >
                              {entry.rank <= 3 ? (
                                <Icon
                                  ...
                                  className={`text-sm ${positionStyle.color}`}
                                />
                              ) : (
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              <div className="flex items-center gap-2 text-[11px] text-slate-400">
                                <span>
                                  {t("streak.leaderboard_streak", {
                                    days: entry.streak,
                                  })}
                                </span>
                                <span>·</span>
                                <span>
                                  {t("streak.leaderboard_badges", {
                                    count: entry.badges,
                                  })}
                                </span>
                              </div>
