            ...
            <div className="flex items-center gap-1">
              {FONT_SIZES.map((size) => (
                <button
                  ...
                  className={`w-7 h-7 rounded text-xs font-semibold transition-colors ${fontSize === size ? "bg-[var(--theme-emphasis)] text-[var(--theme-on-emphasis)]" : ""}`}
                  style={
                    fontSize === size
                      ? {}
            ...
            <div className="flex items-center gap-1">
              {FONTS.map((fontOpt) => (
                <button
                  ...
                  className={`px-2 h-7 rounded text-xs font-semibold transition-colors ${fontFamily === fontOpt.id ? "bg-[var(--theme-emphasis)] text-[var(--theme-on-emphasis)]" : ""}`}
                  style={
