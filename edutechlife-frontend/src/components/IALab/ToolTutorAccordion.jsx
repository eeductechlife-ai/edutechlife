...
const ToolTutorAccordion = React.memo(function ToolTutorAccordion({ onAction }) {
              ...
              {!isActive && (
                <div className="mt-auto pt-3">
                  <div className="inline-flex items-center gap-2 px-4 py-2.5 bg-gradient-to-r from-petroleum to-corporate rounded-xl shadow-sm hover:from-petroleum-dark hover:to-corporate-dark hover:shadow group-hover:scale-105 transition-all duration-300">
                    ...
                    <Icon name="fa-chevron-right" className="w-3 h-3 text-white group-hover:translate-x-0.5 transition-transform duration-300" aria-hidden="true" />
                  </div>
                </div>
              )}
            </div>
  ...
  return (
    <div className="space-y-4">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5 items-stretch">
        ...
        <PreviewCard config={flashcardConfig} section="flashcards" />
          ...
          >
            <div className="pb-1">
              <Suspense fallback={<div className="h-32 animate-pulse bg-slate-100 dark:bg-slate-800 rounded-2xl" />}>
                {expanded === 'tool' ? (
                  <SectionErrorBoundary name="ToolSection" title={toolConfig.title}>
                  ...
                  <SectionErrorBoundary name="TutoringSection" title="Error al cargar tutorías virtuales">
