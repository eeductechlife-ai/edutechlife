        ...
        <div className="flex flex-col md:flex-row gap-8 items-center">
          <div className="flex-1 space-y-6">
            <div className="flex items-center justify-between">
              <h2 className="text-3xl font-bold text-[var(--theme-emphasis)]">{t('ova.buildgpt.intro_title')}</h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
              <div className="bg-cyan-50 dark:bg-slate-700/30 p-5 rounded-xl border border-cyan-100 dark:border-slate-600">
                ...
                <h3 className="font-bold text-[var(--theme-emphasis)] mb-2">{t('ova.buildgpt.intro_gpt_title')}</h3>
              ...
              <div className="bg-gradient-to-br from-[var(--theme-primary)]/10 to-[var(--theme-emphasis)]/10 p-5 rounded-xl border border-[var(--theme-primary)]/30 shadow-sm relative overflow-hidden">
                <div className="absolute top-0 right-0 p-2"><CheckCircle className="text-[var(--theme-primary)]" size={20}/></div>
                <Workflow className="text-[var(--theme-emphasis)] mb-3" size={28} />
                <h3 className="font-bold text-[var(--theme-emphasis)] mb-2">{t('ova.buildgpt.intro_actions_title')}</h3>
