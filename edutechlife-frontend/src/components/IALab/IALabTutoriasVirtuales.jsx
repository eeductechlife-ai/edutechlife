...
const IALabTutoriasVirtuales = () => {
  ...
  return (
    <motion.div
      ...
      className="relative z-10 bg-white rounded-2xl border border-slate-200/60 shadow-sm p-4 md:p-6 overflow-hidden"
    >
      <div className="absolute -top-6 -right-6 w-20 md:w-32 h-20 md:h-32 bg-gradient-to-br from-[#004B63]/6 to-[#00BCD4]/4 rounded-full blur-2xl pointer-events-none" />
      <div className="absolute -bottom-6 -left-6 w-20 md:w-32 h-20 md:h-32 bg-gradient-to-tr from-[#004B63]/4 to-[#00BCD4]/4 rounded-full blur-2xl pointer-events-none" />
          ...
          <div>
            ...
            {!active && (
              <div className="flex items-center gap-2 mt-3 text-sm text-slate-500">
                ...
                <span>
                  Próxima tutoría en <span className="font-semibold text-[#004B63] font-mono">{formatCountdown()}</span>
                </span>
              </div>
            )}
          </div>
