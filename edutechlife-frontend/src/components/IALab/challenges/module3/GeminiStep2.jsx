    ...
    return (
      <div className="flex flex-col items-center justify-center py-12 text-slate-400 dark:text-slate-500">
        ...
        <p className="text-xs mt-1">
          {translate("ialab.challenge.m3.step2_no_sources_desc")}
        </p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="flex items-center gap-3 mb-3">
          ...
          <div>
            <h3 className="text-lg font-bold text-slate-800 dark:text-slate-100">
              {translate("ialab.challenge.m3.step2_title")}
            </h3>
            <p className="text-slate-500 dark:text-slate-400 text-sm">
              {translate("ialab.challenge.m3.step2_subtitle")}
            </p>
          </div>
        </div>
      </motion.div>

      <ResearchContextBanner topic={topic} stepNumber={2} moduleId={3} />
      ...
      >
        ...
        <ExampleToggle
          example={translate("ialab.challenge.m3.step2_example_data")}
        />
      </motion.div>
      ...
      >
        {fuentes.map((fuente, i) => {
          ...
          const colorClasses =
            SOURCE_TYPE_COLORS[fuente.tipo] ||
            ...
            >
              <div className="p-5">
                <div className="flex items-start gap-4">
                  <div
                    className={`w-12 h-12 rounded-xl ${bgColor} dark:opacity-80 ${borderColor} dark:border-slate-600 border flex items-center justify-center flex-shrink-0`}
                  >
                    ...
                    <div className="flex items-start justify-between gap-3">
                      ...
                      >
                        <input
                          ...
                          onChange={(e) =>
                            updateSource(i, { isRelevant: e.target.checked })
                          }
                      ...
                      <div className="mt-4">
                        ...
                        <AutoGrowTextarea
                          ...
                          placeholder={translate(
                            "ialab.challenge.m3.step2_keydata_placeholder",
                          )}
                          maxLength={500}
                        />
                      </div>
