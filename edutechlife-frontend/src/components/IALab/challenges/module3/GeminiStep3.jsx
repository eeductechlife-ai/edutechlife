...
const VERDICTS = [
  {
    value: "verified",
    labelKey: "ialab.challenge.m3.step3_verified",
    icon: "fa-check-circle",
    color:
      "text-emerald-600 bg-emerald-50 border-emerald-200 hover:bg-emerald-100 active:bg-emerald-200",
  },
  {
    value: "questionable",
    labelKey: "ialab.challenge.m3.step3_questionable",
    icon: "fa-exclamation-triangle",
    color:
      "text-amber-600 bg-amber-50 border-amber-200 hover:bg-amber-100 active:bg-amber-200",
  },
  {
    value: "unverifiable",
    labelKey: "ialab.challenge.m3.step3_unverifiable",
    icon: "fa-circle-question",
    color:
      "text-slate-600 bg-slate-50 border-slate-200 hover:bg-slate-100 active:bg-slate-200",
  },
];
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="flex items-center gap-3 mb-3">
          ...
          <div>
            <h3 className="text-lg font-bold text-slate-800 dark:text-slate-100">
              {translate("ialab.challenge.m3.step3_title")}
            </h3>
            <p className="text-slate-500 dark:text-slate-400 text-sm">
              {translate("ialab.challenge.m3.step3_subtitle")}
            </p>
          </div>
        </div>
      </motion.div>

      <ResearchContextBanner topic={topic} stepNumber={3} moduleId={3} />
      ...
      >
        ...
        <ExampleToggle
          example={translate("ialab.challenge.m3.step3_example_reasoning")}
        />
      </motion.div>
            ...
            >
              <div className="p-5">
                <div className="flex items-start gap-3 mb-4">
                  ...
                  <p className="text-slate-700 dark:text-slate-200 leading-relaxed pt-1">
                    {afirmacion.texto}
                  </p>
                </div>
                  ...
                  {VERDICTS.map((v) => {
                    ...
                    return (
                      <motion.button
                        key={v.value}
                        onClick={() =>
                          updateClaim(i, { verdict: selected ? null : v.value })
                        }
                        whileTap={
                  ...
                  >
                    ...
                    <AutoGrowTextarea
                      ...
                      placeholder={translate(
                        "ialab.challenge.m3.step3_reason_placeholder",
                      )}
                      maxLength={500}
                    />
                  </motion.div>
