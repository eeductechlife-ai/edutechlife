    ...
    <div className="space-y-4 sm:space-y-6">
      ...
      {tema ? (
        <motion.div
          ...
          className="bg-gradient-to-br from-[var(--theme-emphasis)]/5 to-[var(--theme-primary)]/5 dark:from-[var(--theme-emphasis)]-dark/10 dark:to-[var(--theme-primary)]-dark/5 rounded-xl p-4 sm:p-5 border border-[var(--theme-emphasis)]/10 dark:border-[var(--theme-emphasis)]-dark/20"
        >
