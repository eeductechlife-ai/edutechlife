...
const TONE_OPTIONS = [
  {
    id: "professional",
    icon: "fa-briefcase",
    labelKey: "ialab.challenge.m2.step2_tone_professional",
  },
  {
    id: "casual",
    icon: "fa-comment",
    labelKey: "ialab.challenge.m2.step2_tone_casual",
  },
  {
    id: "technical",
    icon: "fa-microchip",
    labelKey: "ialab.challenge.m2.step2_tone_technical",
  },
  {
    id: "creative",
    icon: "fa-palette",
    labelKey: "ialab.challenge.m2.step2_tone_creative",
  },
];
  ...
  const base = [
    {
      id: "manual",
      icon: "fa-file-pdf",
      labelKey: "ialab.challenge.m2.step2_knowledge_manual",
      descKey: "ialab.challenge.m2.step2_knowledge_manual_desc",
    },
    {
      id: "faq",
      icon: "fa-file-alt",
      labelKey: "ialab.challenge.m2.step2_knowledge_faq",
      descKey: "ialab.challenge.m2.step2_knowledge_faq_desc",
    },
  ];
  if (selectedCase === "dev")
    return [
      ...base,
      {
        id: "schema",
        icon: "fa-layer-group",
        labelKey: "ialab.challenge.m2.step2_knowledge_schema",
        descKey: "ialab.challenge.m2.step2_knowledge_schema_desc",
      },
    ];
  if (selectedCase === "marketing")
    return [
      ...base,
      {
        id: "brand",
        icon: "fa-palette",
        labelKey: "ialab.challenge.m2.step2_knowledge_brand",
        descKey: "ialab.challenge.m2.step2_knowledge_brand_desc",
      },
    ];
  if (selectedCase === "support")
    return [
      ...base,
      {
        ...
        labelKey: "ialab.challenge.m2.step2_knowledge_crm",
        descKey: "ialab.challenge.m2.step2_knowledge_crm_desc",
      },
    ];
  return base;
};
  ...
  const all = [
    {
      id: "web",
      icon: "fa-globe",
      labelKey: "ialab.challenge.m2.step2_cap_web",
    },
    {
      id: "dalle",
      icon: "fa-image",
      labelKey: "ialab.challenge.m2.step2_cap_dalle",
    },
    {
      id: "code",
      icon: "fa-code",
      labelKey: "ialab.challenge.m2.step2_cap_code",
    },
    {
      id: "data",
      icon: "fa-calculator",
      labelKey: "ialab.challenge.m2.step2_cap_data",
    },
  ];
  if (selectedCase === "marketing") return all.filter((c) => c.id !== "code");
  if (selectedCase === "dev") return all.filter((c) => c.id !== "dalle");
  if (selectedCase === "support")
    return all.filter((c) => c.id !== "dalle" && c.id !== "data");
  return all;
};
...
const ChatGPTStep2 = ({
  ...
  const emitChange = (updates) => {
    const next = {
      ...
      knowledge:
        updates.knowledge !== undefined ? updates.knowledge : knowledge,
      capabilities:
  ...
  if (knowledge.length)
    previewLines.push(
      `Conocimiento: ${knowledge.map((k) => t(knowledgeFiles.find((f) => f.id === k)?.labelKey || k)).join(", ")}`,
    );
  if (capabilities.length)
    previewLines.push(
      `Capacidades: ${capabilities.map((c) => t(capabilitiesList.find((ca) => ca.id === c)?.labelKey || c)).join(", ")}`,
    );
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="min-w-0 flex-1">
            <h2 className="text-xl font-bold text-slate-800 dark:text-slate-100">
              {t("ialab.challenge.m2.step2_title")}
            </h2>
            <p className="text-slate-500 dark:text-slate-400 text-sm mt-1">
              {t("ialab.challenge.m2.step2_subtitle")}
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-gradient-to-r from-amber-50 to-orange-50 dark:from-amber-900/10 dark:to-orange-900/10 rounded-xl p-5 border border-amber-200 dark:border-amber-700/30">
        <div className="flex items-center gap-2 mb-2">
          ...
          <h3 className="text-base font-semibold text-slate-800 dark:text-slate-100">
            {t("ialab.challenge.m2.step2_config_context")}
          </h3>
        </div>
        ...
        <div className="space-y-6">
          <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-600 rounded-xl p-6 space-y-4">
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-base font-semibold text-slate-800 dark:text-slate-100">
                {t("ialab.challenge.m2.step2_role")}
              </h3>
            </div>
            <input
              type="text"
              ...
              value={gptRole}
              onChange={(e) => {
                setGptRole(e.target.value);
                emitChange({ gptRole: e.target.value });
              }}
          ...
          <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-600 rounded-xl p-6 space-y-4">
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-base font-semibold text-slate-800 dark:text-slate-100">
                {t("ialab.challenge.m2.step2_tone")}
              </h3>
            </div>
          ...
          <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-600 rounded-xl p-6 space-y-4">
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-base font-semibold text-slate-800 dark:text-slate-100">
                {t("ialab.challenge.m2.step2_rules")}
              </h3>
            </div>
            <AutoGrowTextarea
              value={rules}
        ...
        <div className="space-y-6">
          <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-600 rounded-xl p-6 space-y-4">
            <div className="flex items-center gap-2">
              ...
              <div>
                <h3 className="text-base font-semibold text-slate-800 dark:text-slate-100">
                  {t("ialab.challenge.m2.step2_knowledge")}
                </h3>
                <p className="text-xs text-slate-500 dark:text-slate-400">
                  {t("ialab.challenge.m2.step2_knowledge_hint")}
                </p>
              </div>
            </div>
            <div className="flex flex-wrap gap-2">
                ...
                return (
                  <button
                    ...
                    className={`flex items-center gap-2 px-3 py-2 rounded-xl border-2 text-sm transition-all duration-200 ${
                      isSelected
                        ? "bg-[var(--theme-primary)]/10 border-[var(--theme-primary)] text-[var(--theme-primary)] dark:bg-[var(--theme-primary)]/20 dark:text-[var(--theme-primary)]"
                  ...
                  >
                    <Icon
                      name={file.icon}
                      className={`text-sm ${isSelected ? "text-[var(--theme-primary)]" : "text-slate-400"}`}
                    />
          ...
          <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-600 rounded-xl p-6 space-y-4">
            <div className="flex items-center gap-2">
              ...
              <div>
                <h3 className="text-base font-semibold text-slate-800 dark:text-slate-100">
                  {t("ialab.challenge.m2.step2_capabilities")}
                </h3>
                <p className="text-xs text-slate-500 dark:text-slate-400">
                  {t("ialab.challenge.m2.step2_capabilities_hint")}
                </p>
              </div>
            </div>
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <div
                        className={`w-8 h-8 rounded-lg flex items-center justify-center ${isEnabled ? "bg-[var(--theme-primary)]/10 dark:bg-mint/20" : "bg-slate-100 dark:bg-slate-600"}`}
                      >
                        <Icon
                          name={cap.icon}
                          className={`text-sm ${isEnabled ? "text-[var(--theme-primary)] dark:text-mint" : "text-slate-400 dark:text-slate-500"}`}
                        />
                      </div>
                      <span
                        className={`text-sm font-medium ${isEnabled ? "text-slate-800 dark:text-slate-100" : "text-slate-500 dark:text-slate-400"}`}
                      >
                        {t(cap.labelKey)}
                      </span>
                    </div>
                    <div
                      className={`relative w-10 h-5 rounded-full transition-colors duration-200 ${isEnabled ? "bg-[var(--theme-primary)] dark:bg-mint" : "bg-slate-300 dark:bg-slate-600"}`}
                    >
                      <div
                        className={`absolute top-0.5 w-4 h-4 rounded-full bg-white shadow transition-transform duration-200 ${isEnabled ? "translate-x-5" : "left-0.5"}`}
                      />
                    </div>
                  </button>
                );
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-semibold text-slate-700 dark:text-slate-300">
              {t("ialab.challenge.m2.step2_preview_title")}
            </span>
          </div>
          <Icon
            name={showPreview ? "fa-chevron-up" : "fa-chevron-down"}
            ...
            <div className="bg-slate-900 dark:bg-slate-950 rounded-xl p-5 font-mono text-xs leading-relaxed">
              {previewLines.length > 0 ? (
                  ...
                  <div key={i} className="mb-2">
                    {line.startsWith("Reglas:") ? (
                      <>
                        ...
                        <pre className="text-slate-300 mt-1 whitespace-pre-wrap pl-3">
                          {rules}
                        </pre>
                      </>
                    ) : line.startsWith("Conocimiento:") ||
                ...
                <p className="text-slate-500 italic">
                  {t("ialab.challenge.m2.step2_preview_empty")}
                </p>
              )}
            </div>
          </motion.div>
      ...
      <div className="bg-gradient-to-r from-amber-50 to-orange-50 dark:from-amber-900/10 dark:to-orange-900/10 rounded-xl p-5 border border-amber-200 dark:border-amber-700/30">
        <div className="flex items-center gap-3 mb-3">
          ...
          <h3 className="text-lg font-semibold text-slate-800 dark:text-slate-100">
            {t("ialab.challenge.m2.step2_tips_title")}
          </h3>
        </div>
