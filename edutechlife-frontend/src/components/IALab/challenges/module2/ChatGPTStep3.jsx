  ...
  const base = [
    {
      id: "id",
      icon: "fa-hashtag",
      labelKey: "ialab.challenge.m2.step3_field_id",
    },
    {
      id: "name",
      icon: "fa-tag",
      labelKey: "ialab.challenge.m2.step3_field_name",
    },
  ];
  if (selectedCase === "marketing")
    return [
      ...base,
      {
        id: "dateRange",
        icon: "fa-calendar",
        labelKey: "ialab.challenge.m2.step3_field_daterange",
      },
      {
        id: "platform",
        icon: "fa-globe",
        labelKey: "ialab.challenge.m2.step3_field_platform",
      },
    ];
  if (selectedCase === "support")
    return [
      ...base,
      {
        id: "priority",
        icon: "fa-flag",
        labelKey: "ialab.challenge.m2.step3_field_priority",
      },
      {
        id: "description",
        icon: "fa-align-left",
        labelKey: "ialab.challenge.m2.step3_field_description",
      },
    ];
  if (selectedCase === "dev")
    return [
      ...base,
      {
        id: "repo",
        icon: "fa-code-branch",
        labelKey: "ialab.challenge.m2.step3_field_repo",
      },
      {
        id: "tags",
        icon: "fa-tags",
        labelKey: "ialab.challenge.m2.step3_field_tags",
      },
    ];
  return base;
};
...
const ChatGPTStep3 = ({
  ...
  const emitChange = (updates) => {
    const next = {
      functionName:
        updates.functionName !== undefined
          ? updates.functionName
          : functionName,
      selectedFields:
        updates.selectedFields !== undefined
          ? updates.selectedFields
          : selectedFields,
      returnValue:
        updates.returnValue !== undefined ? updates.returnValue : returnValue,
    };
  ...
  const generatedSchema = useMemo(() => {
    ...
    return {
      ...
      description: t("ialab.challenge.m2.step3_schema_desc", {
        returnValue: returnValue || "resultado",
      }),
      parameters: {
        type: "object",
        properties: props,
  ...
  const getExample = () => {
    const examples = {
      marketing:
        'generarInformeRedes("cliente-123", "2026-01-01", "2026-03-31", "instagram,facebook")',
      support:
        'crearTicketSoporte("cliente-456", "alta", "El usuario no puede acceder a su cuenta desde el lunes")',
    ...
    <div className="space-y-6">
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="min-w-0 flex-1">
            <h2 className="text-xl font-bold text-slate-800 dark:text-slate-100">
              {t("ialab.challenge.m2.step3_title")}
            </h2>
            <p className="text-slate-500 dark:text-slate-400 text-sm mt-1">
              {t("ialab.challenge.m2.step3_subtitle")}
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-gradient-to-r from-[var(--theme-emphasis)]/5 to-[var(--theme-primary)]/5 rounded-xl p-5 border border-[var(--theme-primary)]/20">
        <div className="flex items-center gap-2 mb-2">
          <Icon name="fa-bullseye" className="text-[var(--theme-primary)]" />
          <h3 className="text-base font-semibold text-slate-800 dark:text-slate-100">
            {t("ialab.challenge.m2.step3_spec_context")}
          </h3>
        </div>
      ...
      <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-600 rounded-xl p-6 space-y-4">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-base font-semibold text-slate-800 dark:text-slate-100">
            {t("ialab.challenge.m2.step3_function_name")}
          </h3>
        </div>
        <input
          type="text"
          ...
          onChange={(e) => {
            ...
            emitChange({ functionName: e.target.value });
          }}
      ...
      <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-600 rounded-xl p-6 space-y-4">
        <div className="flex items-center gap-2">
          ...
          <div>
            <h3 className="text-base font-semibold text-slate-800 dark:text-slate-100">
              {t("ialab.challenge.m2.step3_data_needed")}
            </h3>
            <p className="text-xs text-slate-500 dark:text-slate-400">
              {t("ialab.challenge.m2.step3_data_needed_hint")}
            </p>
          </div>
        </div>
          ...
          {dataFields.map((field) => {
            ...
            return (
              ...
              >
                <Icon
                  name={field.icon}
                  className={`text-sm ${isSelected ? "text-[var(--theme-primary)] dark:text-mint" : "text-slate-400"}`}
                />
      ...
      <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-600 rounded-xl p-6 space-y-4">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-base font-semibold text-slate-800 dark:text-slate-100">
            {t("ialab.challenge.m2.step3_return")}
          </h3>
        </div>
        <AutoGrowTextarea
          value={returnValue}
      ...
      {functionName && selectedFields.length > 0 && (
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-base font-semibold text-slate-800 dark:text-slate-100">
              {t("ialab.challenge.m2.step3_schema_generated")}
            </h3>
          </div>
