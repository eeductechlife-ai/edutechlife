...
const CATEGORIES = [
  {
    key: "cientifica",
    labelKey: "ialab.challenge.m4.step1.category_cientifica",
  },
  ...
  {
    key: "complementario",
    labelKey: "ialab.challenge.m4.step1.category_complementario",
  },
];
...
const M4_STEPS = [
  {
    key: "step1",
    icon: "fa-bookmark",
    labelKey: "ialab.challenge.m4.step1_title",
  },
  {
    key: "step2",
    icon: "fa-compress",
    labelKey: "ialab.challenge.m4.step2_title",
  },
  {
    key: "step3",
    icon: "fa-microphone",
    labelKey: "ialab.challenge.m4.step3_title",
  },
];
...
const NotebookStep1 = ({
  ...
  const parseResponse = useCallback(() => {
    ...
    try {
      ...
      return { documents: parsed.documents || parsed.conceptos || [] };
    } catch {
      return { documents: [] };
    }
  }, [response]);
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="flex items-center gap-3 mb-3">
          ...
          <div>
            <h3 className="text-lg font-bold text-slate-800 dark:text-slate-100">
              {t("ialab.challenge.m4.step1.title")}
            </h3>
            <p className="text-slate-500 dark:text-slate-400 text-sm">
              {t("ialab.challenge.m4.step1.subtitle")}
            </p>
          </div>
        </div>
      </motion.div>
      ...
      >
        ...
        <ExampleToggle
          example={t("ialab.challenge.m4.step1_example_insight")}
        />
      </motion.div>
      ...
      >
        <h4 className="text-lg font-semibold text-slate-800 dark:text-slate-100">
          {t("ialab.challenge.m4.step1.documents_title")}
        </h4>
        <span
          className={`text-sm font-medium ${maxReached ? "text-amber-600 dark:text-amber-400" : "text-slate-500 dark:text-slate-400"}`}
        >
        ...
        {maxReached && (
          ...
          >
            ...
            <span className="text-xs font-medium text-amber-700 dark:text-amber-400">
              {t("ialab.challenge.m4.step1.max_reached")}
            </span>
          </motion.div>
        )}
      </AnimatePresence>
              ...
              <div className="p-5">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p
                      className={`text-sm text-slate-500 dark:text-slate-400 leading-relaxed ${expandedContent[index] ? "" : "line-clamp-2"}`}
                    >
                      {doc.contenido}
                    </p>
                    <button
                    ...
                    >
                      {expandedContent[index]
                        ...
                        : t("ialab.challenge.m4.step1.show_content")}
                    </button>
                      ...
                      >
                        ...
                        <div>
                          ...
                          <AutoGrowTextarea
                            ...
                            value={entry?.insight || ""}
                            onChange={(v) =>
                              updateDocField(index, "insight", v)
                            }
                            placeholder={t(
                              "ialab.challenge.m4.step1.insight_placeholder",
                            )}
                            maxLength={150}
                          />
                        </div>
      ...
      {documentos.length === 0 && (
        ...
        >
          <Icon
            name="fa-lightbulb"
            className="text-slate-300 dark:text-slate-600 text-3xl mx-auto mb-3"
          />
          <p className="text-slate-500 dark:text-slate-400">
            {t("ialab.challenge.m4.step1.no_documents")}
          </p>
        </motion.div>
      )}
