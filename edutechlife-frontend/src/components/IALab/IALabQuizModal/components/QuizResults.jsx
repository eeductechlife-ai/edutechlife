    ...
    <div className="mb-6">
      ...
      >
        <span className="text-sm font-medium text-slate-700 dark:text-slate-300">
          <Icon name="fa-list-check" className="text-sm mr-2" aria-hidden="true" />
              ...
              >
                <div className="flex items-start gap-3">
                  <div className={`w-7 h-7 rounded-full flex items-center justify-center flex-shrink-0 text-white text-xs font-bold ${
                    ...
                    <Icon name={isCorrect ? 'fa-check' : 'fa-xmark'} className="text-xs" aria-hidden="true" />
                  </div>
        ...
        {!quizPassed && quizResult?.failedQuestions?.length > 0 && (
          <div className="bg-red-50 border border-red-200 rounded-xl p-4 mb-6">
            <h4 className="text-xs font-bold text-red-700 mb-2 flex items-center gap-1.5">
              <Icon name="fa-lightbulb" className="text-sm" aria-hidden="true" />
        ...
        {quizPassed && (
          <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-4 mb-6">
            <h4 className="text-xs font-bold text-emerald-700 mb-1 flex items-center gap-1.5">
              <Icon name="fa-check-circle" className="text-sm" aria-hidden="true" />
