...
const ModuleInfoSection = ({ className = "", ...rest }) => {
  ...
  return (
    ...
    >
      ...
      <div className="relative px-5 md:px-7 pt-6 pb-5 bg-gradient-to-br from-[var(--theme-emphasis)]/[0.06] to-[var(--theme-primary)]/[0.03] dark:from-[var(--theme-emphasis)]/[0.12] dark:to-[var(--theme-primary)]/[0.06] border-b border-[var(--theme-emphasis)]/10 dark:border-[var(--theme-emphasis)]/15">
        {/* Barra top */}
        ...
        <div className="flex items-start gap-4">
          <div className="w-11 h-11 rounded-2xl bg-gradient-to-br from-[var(--theme-emphasis)] to-[var(--theme-primary)] shadow-lg shadow-[var(--theme-emphasis)]/20 flex items-center justify-center flex-shrink-0">
            <Icon name="fa-bullseye" className="text-white text-base" />
          </div>
          <div className="flex-1 min-w-0">
            <h4 className="text-[10px] font-bold theme-text-emphasis uppercase tracking-[0.14em] mb-1.5 font-montserrat">
          ...
          {moduleScore > 0 && (
            <div
              className={`flex-shrink-0 flex items-center gap-1 rounded-full px-2.5 py-1 text-[11px] font-bold ${
                isModuleCompleted
      ...
      <div className="px-5 md:px-7 pt-5 pb-4">
        <div className="flex items-center justify-between mb-3">
          <h4 className="text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-[0.12em] font-montserrat">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
          {moduleData.learningPoints.map((point, index) => (
            ...
            >
              <div
                className={`w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0 shadow-sm transition-all duration-300 ${
                  isModuleCompleted
