...
const StepIndicator = ({ current, total }) => (
  <div className="flex items-center justify-center gap-2 mb-6">
    {Array.from({ length: total }, (_, i) => (
      <div
        key={i}
        className={`h-2 rounded-full transition-all duration-500 ${i < current ? "w-8 bg-[var(--theme-primary)]" : i === current ? "w-8 bg-[var(--theme-emphasis)]" : "w-2 bg-slate-200 dark:bg-slate-600"}`}
      />
    ))}
  </div>
);
      ...
      <>
        <div className="ialab-animate-fade-in px-4 py-8">
          <div className="max-w-3xl mx-auto text-center mb-8">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-cyan-100 dark:bg-cyan-900/30 text-[var(--theme-emphasis)] dark:text-slate-100 font-semibold text-sm mb-4">
              <Monitor className="w-4 h-4 text-[var(--theme-primary)]" />
              <span>{t("ova.podcaststudio.badge_project")}</span>
            </div>
            <h2 className="text-2xl md:text-3xl font-bold text-[var(--theme-emphasis)] dark:text-slate-100 mb-2">
          ...
          <div className="max-w-3xl mx-auto space-y-8">
            {showType && (
              <div>
                <h3 className="text-lg font-bold text-[var(--theme-emphasis)] dark:text-slate-100 mb-4 text-center">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                  {CONTENT_TYPES.map((t) => (
                    <button
                      ...
                      className="bg-white dark:bg-slate-800 rounded-2xl p-5 text-center border-2 border-slate-200 dark:border-slate-600 hover:border-[var(--theme-primary)] hover:shadow-lg transition-all cursor-pointer group"
                    >
                      <div className="text-3xl mb-2">{t.icon}</div>
                      <div className="font-bold text-sm text-[var(--theme-emphasis)] dark:text-slate-100 group-hover:text-[var(--theme-primary)] transition-colors">
                        {t.label}
                      </div>
        ...
        <div className="ialab-animate-fade-in px-4 py-8">
          ...
          <div className="max-w-3xl mx-auto space-y-4 mb-8">
            <div className="flex flex-wrap justify-center gap-2">
              <span className="px-4 py-2 bg-cyan-50 text-[var(--theme-emphasis)] dark:text-slate-100 rounded-xl text-sm font-semibold border border-cyan-200">
                {cType?.icon} {cType?.label}
              </span>
              <span className="px-4 py-2 bg-purple-50 dark:bg-purple-900/20 text-[var(--theme-emphasis)] dark:text-slate-100 rounded-xl text-sm font-semibold border border-purple-200">
                {g?.icon} {g?.label}
              </span>
              <span className="px-4 py-2 bg-amber-50 dark:bg-amber-900/20 text-[var(--theme-emphasis)] dark:text-slate-100 rounded-xl text-sm font-semibold border border-amber-200">
            ...
            <div className="bg-white dark:bg-slate-800 rounded-2xl p-6 border border-slate-200 dark:border-slate-600 shadow-sm">
              <h3 className="font-bold text-[var(--theme-emphasis)] dark:text-slate-100 mb-4 flex items-center gap-2">
                <Pencil className="w-[18px] h-[18px] text-[var(--theme-primary)]" />
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                <div className="p-4 rounded-xl bg-slate-50 dark:bg-slate-700/30 border border-slate-100 dark:border-slate-700">
                  ...
                  <div className="text-lg font-bold text-[var(--theme-emphasis)] dark:text-slate-100">
                    {recs.idealSources}
                  </div>
          ...
          <div className="text-center">
            <button
              ...
              className="px-8 py-3 bg-gradient-to-r from-[var(--theme-primary)] to-[var(--theme-emphasis)] text-white rounded-xl font-bold shadow-md hover:shadow-lg transition-all inline-flex items-center gap-2"
            >
        ...
        <div className="max-w-3xl mx-auto text-center mb-8">
          ...
          <div className="bg-white dark:bg-slate-800 rounded-2xl p-6 border border-slate-200 dark:border-slate-600 shadow-sm mb-6">
            <div className="flex justify-between items-center mb-4">
              <span className="text-sm font-bold text-[var(--theme-emphasis)] dark:text-slate-100">
            ...
            >
              <div
                className="bg-gradient-to-r from-[var(--theme-primary)] to-[var(--theme-emphasis)] h-full rounded-full transition-all duration-500"
              ...
              <button
                ...
                className={`w-full flex items-center gap-4 p-4 rounded-2xl border-2 transition-all text-left ${
                  checked[item.id]
                    ...
                    : "bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-600 hover:border-[var(--theme-primary)]"
                }`}
              >
                <div
          ...
          <div className="flex justify-center gap-3">
            <button
              onClick={handleStart}
              className="px-6 py-3 bg-white dark:bg-slate-800 text-[var(--theme-emphasis)] dark:text-slate-100 border-2 border-slate-200 dark:border-slate-600 hover:border-[var(--theme-primary)] rounded-xl font-semibold transition-all inline-flex items-center gap-2"
            >
