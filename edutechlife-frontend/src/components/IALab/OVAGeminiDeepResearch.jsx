    ...
    findings: [
      {
        ...
        key: "ialab.gemini_research.find_image_1",
      },
      {
        icon: "fa-check-circle",
        color: "text-emerald-600",
        key: "ialab.gemini_research.find_image_2",
      },
      {
        icon: "fa-shield",
        color: "text-amber-600",
        key: "ialab.gemini_research.find_image_3",
      },
      {
        icon: "fa-lightbulb",
        color: "text-blue-600",
        key: "ialab.gemini_research.find_image_4",
      },
    ],
  },
  factcheck: {
    ...
    findings: [
      {
        icon: "fa-check-circle",
        color: "text-emerald-600",
        key: "ialab.gemini_research.find_fact_1",
      },
      {
        icon: "fa-check-circle",
        color: "text-emerald-600",
        key: "ialab.gemini_research.find_fact_2",
      },
      {
        icon: "fa-circle-exclamation",
        color: "text-red-600",
        key: "ialab.gemini_research.find_fact_3",
      },
      {
        icon: "fa-lightbulb",
        color: "text-blue-600",
        key: "ialab.gemini_research.find_fact_4",
      },
    ],
  },
  deep: {
    ...
    findings: [
      {
        icon: "fa-check-circle",
        color: "text-emerald-600",
        key: "ialab.gemini_research.find_deep_1",
      },
      {
        icon: "fa-check-circle",
        color: "text-emerald-600",
        key: "ialab.gemini_research.find_deep_2",
      },
      {
        icon: "fa-shield",
        color: "text-amber-600",
        key: "ialab.gemini_research.find_deep_3",
      },
      {
        icon: "fa-chart-line",
        color: "text-blue-600",
        key: "ialab.gemini_research.find_deep_4",
      },
    ],
  },
};
          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 max-w-lg mx-auto mb-8">
              {[
                {
                  icon: "fa-image",
                  key: "ialab.gemini_research.intro_point_1",
                },
                {
                  icon: "fa-check-double",
                  key: "ialab.gemini_research.intro_point_2",
                },
                {
                  icon: "fa-compass",
                  key: "ialab.gemini_research.intro_point_3",
                },
              ].map((p) => (
                <div
                  key={p.key}
        ...
        {step === 1 && (
          ...
          >
            ...
            <p className="text-sm text-slate-500 text-center mb-6">
              {t("ialab.gemini_research.select_desc")}
            </p>
              ...
              {RESEARCH_TYPES.map((rt) => (
                ...
                >
                  ...
                  <div className="relative z-10">
                    <div
                      className={`w-12 h-12 rounded-xl ${rt.color} flex items-center justify-center mb-3 shadow-sm`}
                    >
        ...
        {step === 2 && selectedType && (
          ...
          >
            <div className="flex items-center gap-3 mb-5">
              <div
                className={`w-10 h-10 rounded-xl ${RESEARCH_TYPES.find((t) => t.id === selectedType).color} flex items-center justify-center shadow-sm flex-shrink-0`}
              >
                <Icon
                  name={RESEARCH_TYPES.find((t) => t.id === selectedType).icon}
              ...
              <div>
                ...
                <p className="text-xs text-slate-500">
                  {t("ialab.gemini_research.results_subtitle")}
                </p>
              </div>
            </div>
              ...
              <div className="space-y-2">
                {ANALYSIS_SAMPLES[selectedType].findings.map((f, i) => (
                  ...
                  >
                    <Icon
                      name={f.icon}
                      className={`${f.color} w-4 h-4 mt-0.5 flex-shrink-0`}
                    />
            ...
            <div className="bg-white dark:bg-slate-800 rounded-2xl p-5 border border-slate-200 dark:border-slate-700 mb-6">
              ...
              <div className="flex items-center justify-between mb-4">
                <span className="text-sm text-slate-600 dark:text-slate-300">
                  {t("ialab.gemini_research.report_confidence")}
                </span>
                ...
                <span className="text-xs font-bold text-indigo-500">
                  {selectedType === "image"
                    ...
                    : selectedType === "factcheck"
                      ? "7"
                      : "12"}{" "}
                  {t("ialab.gemini_research.report_sources_unit")}
                </span>
              </div>
            </div>
