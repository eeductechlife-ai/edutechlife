...
const ZoneHeading = ({ icon, label, id }) => (
  <div className="flex items-center gap-2 px-1">
    ...
    <span
      id={id}
      className="font-display text-[11px] font-bold tracking-[0.14em] uppercase text-[var(--theme-emphasis)] dark:text-[var(--theme-emphasis-soft)] whitespace-nowrap leading-none"
    >
      {label}
    </span>
