...
const TooltipIcon = ({ label, children, premium }) => {
  ...
  return (
    ...
    >
      {children}
      {premium ? (
        <div className="absolute left-full ml-3 top-1/2 -translate-y-1/2 px-3 py-2 bg-white/95 dark:bg-slate-800/95 backdrop-blur-sm border border-petroleum/20 dark:border-petroleum/40 rounded-xl opacity-0 invisible group-hover/tip:opacity-100 group-hover/tip:visible group-focus-within/tip:opacity-100 group-focus-within/tip:visible transition-all duration-200 whitespace-nowrap z-[60] shadow-xl shadow-petroleum/10 pointer-events-none min-w-[140px]" role="tooltip">
