  ...
  return (
    <div className="flex flex-col items-center px-1">
      <button
        ...
        className="relative w-28 h-28 rounded-full bg-white dark:bg-slate-800 shadow-md shadow-[var(--theme-emphasis)]/10 border border-[var(--theme-emphasis)]/15 dark:border-[var(--theme-emphasis)]/40 flex items-center justify-center transition-transform duration-200 hover:scale-[1.03] active:scale-95 focus:outline-none focus:ring-2 focus:ring-[var(--theme-emphasis)]/30 cursor-pointer"
      >
