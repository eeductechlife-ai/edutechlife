...
const FinalChallenge = () => {
  ...
  return (
    <div className="animate-[fadeIn_0.8s_cubic-bezier(0.16,1,0.3,1)_forwards] space-y-4">
      <p className="text-sm text-slate-500 dark:text-slate-300 font-bold">{t('ova.introprompt.challenge_desc')}</p>
      ...
      {!revealed && (
        <button onClick={() => setRevealed(true)}
          className="w-full py-4 bg-gradient-to-r from-petroleum to-corporate text-white font-black rounded-xl flex items-center justify-center gap-2 text-sm uppercase tracking-wider shadow-lg">
          <ArrowLeftRight className="w-5 h-5" /> {t('ova.introprompt.challenge_reveal')}
        </button>
      )}
      {revealed && (
        <div className="p-4 bg-petroleum text-white rounded-xl text-center">
