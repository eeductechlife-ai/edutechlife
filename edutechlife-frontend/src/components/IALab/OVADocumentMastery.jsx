          ...
          >
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1 min-w-0">
                <h5 className="font-[900] text-[var(--theme-emphasis)] dark:text-white text-sm leading-tight">{s.label}</h5>
                {expanded === s.k && (
  ...
  return (
    <div className="animate-[fadeIn_0.8s_cubic-bezier(0.16,1,0.3,1)_forwards] space-y-4">
      ...
      <button
        ...
        disabled={analyzed}
        className="w-full py-2.5 px-4 rounded-xl bg-gradient-to-r from-[var(--theme-emphasis)] to-[var(--theme-primary)] text-white text-xs font-black uppercase tracking-wider shadow-md disabled:opacity-50 transition-all"
      >
            ...
            <button
              ...
              className={`p-2.5 rounded-lg border-2 transition-all text-xs font-bold text-center ${
                elements.includes(opt.k)
                  ? 'border-[var(--theme-primary)] bg-blue-50 dark:bg-slate-700 text-[var(--theme-emphasis)] dark:text-white'
