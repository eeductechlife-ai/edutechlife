  ...
  return (
    ...
    >
      ...
      <div
        ...
        role="dialog"
        aria-modal="true"
        aria-label={t("ialab.study_planner.dialog_aria")}
      >
        {/* Header */}
                ...
                <div className="flex items-center justify-between mb-2">
                  <div className="flex items-center gap-1">
                    <button
                      ...
                      className="w-6 h-6 rounded-lg bg-slate-100 hover:bg-slate-200 dark:bg-slate-700 dark:hover:bg-slate-600 flex items-center justify-center text-[10px] text-slate-600 dark:text-slate-300 transition-all"
                    >
                      ‹
                    </button>
                ...
                <div className="flex items-center justify-between mt-2 pt-2 border-t border-slate-100 dark:border-slate-700 text-[10px] text-slate-500">
                  ...
                  <span>
                    {t("ialab.study_planner.sessions", {
                      count: monthlyCalendar.totalSessions,
                    })}
                  </span>
                  <span className="text-amber-500 font-semibold">
                    <Icon name="fa-fire" className="text-amber-500" /> {streak}d
                  </span>
                </div>
              </div>
