export const LEVEL_CONFIG = [
  ...
  { minLevel: 8, maxLevel: 12, rank: 'Intermedio', emoji: '⚡', color: '#F59E0B' },
  { minLevel: 13, maxLevel: 18, rank: 'Avanzado', emoji: '🚀', color: '#10B981' },
  { minLevel: 19, maxLevel: 25, rank: 'Experto', emoji: '👑', color: '#F97316' },
  { minLevel: 26, maxLevel: Infinity, rank: 'Mentor', emoji: '🧠', color: '#8B5CF6' },
]
