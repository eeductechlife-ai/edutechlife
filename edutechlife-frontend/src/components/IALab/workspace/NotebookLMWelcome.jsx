...
const ICONS = {
  ...
  target:
    "M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20zm0 5a5 5 0 1 0 0 10 5 5 0 0 0 0-10zm0 4a1 1 0 1 0 0 2 1 1 0 0 0 0-2z",
  users:
  ...
  globe:
    "M12 2a10 10 0 1 0 0 20A10 10 0 0 0 12 2zm0 0c-2.76 4-2.76 16 0 20M2 12h20M12 2c2.76 4 2.76 16 0 20",
  ...
  mindmap:
    "M12 3v9m0 0l-4-4m4 4l4-4M12 12v9M3 12h9m0 0l-4 4m4-4l-4-4M12 12h9m0 0l-4 4m4-4l-4-4",
  report: "M9 17H7v-7h2v7zm4 0h-2V7h2v10zm4 0h-2v-4h2v4zM3 3h18v18H3z",
  cards:
    "M4 4h16a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2zm4 8h8M12 8v8",
...
const STUDIO_TILES = [
  {
    key: "desafio",
    labelKey: "ialab.workspace.studio.challenge",
    icon: ICONS.bolt,
    bg: "#f3e8fd",
    color: "#7c4dff",
  ...
  {
    key: "reto",
    labelKey: "ialab.workspace.studio.exam",
    icon: ICONS.target,
    bg: "#fce8e6",
    color: "#d93025",
    action: "OPEN_QUIZ",
  ...
  {
    key: "comunidad",
    labelKey: "ialab.workspace.studio.community",
    icon: ICONS.users,
    bg: "#e6f4ea",
    color: "#188038",
    section: "actividades",
  ...
  {
    key: "tutoria",
    labelKey: "ialab.workspace.studio.tutoring",
  ...
  {
    key: "herramienta",
    labelKey: "ialab.workspace.studio.tool",
    icon: ICONS.wand,
    bg: "#fff8e1",
    color: "#f9ab00",
  ...
  {
    key: "objetivo",
    labelKey: "ialab.workspace.studio.objective",
    icon: ICONS.report,
    bg: "#e8f0fe",
    color: "#1a73e8",
    section: "objetivos",
  ...
  {
    key: "guardado",
    labelKey: "ialab.workspace.studio.saved",
    icon: ICONS.bookmark,
    bg: "#fce8e6",
    color: "#d93025",
    section: "guardados",
...
const START_CARDS = [
  {
    ...
    labelKey: "ialab.workspace.nlm.card_objectives",
    descKey: "ialab.workspace.nlm.card_objectives_desc",
    bg: "#e8f0fe",
    color: "#1a73e8",
    section: "objetivos",
  },
  {
    ...
    labelKey: "ialab.workspace.nlm.card_content",
    descKey: "ialab.workspace.nlm.card_content_desc",
    bg: "#e6f4ea",
    color: "#188038",
    section: "contenido",
  },
  {
    ...
    labelKey: "ialab.workspace.nlm.card_retos",
    descKey: "ialab.workspace.nlm.card_retos_desc",
    bg: "#fce8e6",
    color: "#d93025",
    section: "actividades",
  },
  {
    icon: "M12 2a3 3 0 0 0-3 3v1H6a2 2 0 0 0-2 2v13a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-3V5a3 3 0 0 0-3-3zm0 9a1 1 0 1 1 0 2 1 1 0 0 1 0-2z",
    labelKey: "ialab.workspace.nlm.card_challenge",
    descKey: "ialab.workspace.nlm.card_challenge_desc",
    bg: "#f3e8fd",
    color: "#7c4dff",
    section: "practica",
  },
...
export default function NotebookLMWelcome({
  topics = [],
  sequenceByIndex,
  onSelectSection,
  onSelectTopic,
  ...
  return (
    ...
    >
      ...
      <div className="flex h-full" style={{ minHeight: "inherit" }}>
        {/* ══ FUENTES ══════════════════════════════════════════ */}
        <div
          className={`flex-col flex-shrink-0 border-r ${mobileTab === "fuentes" ? "flex w-full" : "hidden lg:flex"} lg:w-[260px]`}
          style={{ borderColor: "#e0e0e6" }}
        >
          {/* Header */}
          <div
          ...
          >
            <span style={{ fontSize: 15, fontWeight: 600, color: "#202124" }}>
              {t("ialab.workspace.nlm.tab_sources")}
            </span>
            <button
              type="button"
              className="p-1 rounded hover:bg-gray-100"
              style={{ color: "#5f6368" }}
              aria-label={t("ialab.workspace.collapse_panel")}
            >
              <svg
                width="20"
                height="20"
          ...
          <div className="px-3 pb-3">
            <p
              className="text-[10.5px] font-medium mb-2 px-1"
              style={{ color: "#5f6368" }}
            >
              {t("ialab.workspace.nlm.search_web")}
            </p>
            <div className="flex items-center gap-2">
              <button
                type="button"
                className="flex items-center gap-1.5 px-3 py-1.5 rounded-full border text-[12px] font-medium hover:bg-gray-50 transition-colors"
                style={{ borderColor: "#dadce0", color: "#3c4043" }}
              >
                <SvgIcon
                  path={ICONS.globe}
              ...
              <button
                ...
                style={{ color: "#5f6368" }}
                aria-label={t("ialab.workspace.search")}
              >
                <SvgIcon
                  path={ICONS.search}
                  size={18}
          ...
          <div className="flex-1 overflow-y-auto px-3 pb-4">
            {topics.length > 0 ? (
              <>
                <p
                  className="text-[10.5px] font-semibold uppercase tracking-wider px-1 pb-1.5 pt-1"
                  style={{ color: "#9aa0a6" }}
                >
                    ...
                    return (
                      ...
                      >
                        <div
                          ...
                          style={{
                            background: completed ? "#e6f4ea" : "#e8f0fe",
                          }}
                        >
                          <SvgIcon
                            path={ICONS.file}
              ...
              <div className="flex flex-col items-center justify-center text-center h-full px-4">
                ...
                <p
                  ...
                  style={{ color: "#3c4043" }}
                >
                  {t("ialab.workspace.nlm.empty_title")}
                </p>
                <p
        ...
        {/* ══ CHAT ════════════════════════════════════════════ */}
        <div
          className={`flex-col flex-1 min-w-0 ${mobileTab === "chat" ? "flex" : "hidden lg:flex"}`}
        >
          {/* Header */}
          <div
            className="flex items-center justify-between px-4 py-3 border-b"
          ...
          >
            <span style={{ fontSize: 15, fontWeight: 600, color: "#202124" }}>
              {t("ialab.workspace.nlm.tab_chat")}
            </span>
            <div className="flex items-center gap-1">
              <button
                ...
                style={{ color: "#5f6368" }}
                aria-label={t("ialab.workspace.filters")}
              >
                <svg
                  width="18"
                  height="18"
              ...
              <button
                ...
                className="p-1.5 rounded-full hover:bg-gray-100"
                style={{ color: "#5f6368" }}
                aria-label={t("ialab.workspace.more_options")}
              >
                <svg
                  width="18"
                  height="18"
          ...
          >
            ...
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                >
                  {t("ialab.workspace.nlm.module_label", { n: 4 })}
                </p>
                <h2
                  style={{
                    fontSize: 20,
                ...
                >
                  {t("ialab.workspace.nlm.brand")}
                </h2>
                <p style={{ fontSize: 13, color: "#5f6368", marginTop: 2 }}>
                  {t("ialab.workspace.nlm.sub")}
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-6">
              {START_CARDS.map(
                ({ icon, labelKey, descKey, bg, color, section }) => (
                  <button
                    key={labelKey}
                    type="button"
                    onClick={() =>
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <p
                        ...
                        className="group-hover:text-[#1a73e8] transition-colors"
                      >
                        {t(labelKey)}
                      </p>
                      <p
        ...
        {/* ══ STUDIO ══════════════════════════════════════════ */}
        <div
          className={`flex-col flex-shrink-0 border-l ${mobileTab === "studio" ? "flex w-full" : "hidden lg:flex"} lg:w-[260px]`}
          style={{ borderColor: "#e0e0e6" }}
        >
          {/* Header */}
          <div
          ...
          >
            <span style={{ fontSize: 15, fontWeight: 600, color: "#202124" }}>
              {t("ialab.workspace.nlm.tab_studio")}
            </span>
            <button
              type="button"
              className="p-1 rounded hover:bg-gray-100"
          ...
          <div className="flex-1 overflow-y-auto px-3 py-3">
            <div className="grid grid-cols-3 gap-2">
              {STUDIO_TILES.map(
                ({ key, icon, labelKey, bg, color, section, action }) => (
                  <button
                    key={key}
                    type="button"
          ...
          >
            <div className="flex flex-col items-center text-center mb-4">
              ...
              <p
                ...
                style={{ fontSize: 12, color: "#3c4043" }}
              >
...
NotebookLMWelcome.propTypes = {
  topics: PropTypes.arrayOf(
    PropTypes.shape({ title: PropTypes.string, duration: PropTypes.string }),
  ),
