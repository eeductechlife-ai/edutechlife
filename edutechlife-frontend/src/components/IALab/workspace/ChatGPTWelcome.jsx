...
const SUGGEST_CARDS = [
  {
    ...
    labelKey: "ialab.workspace.chatgpt.card_objectives",
    descKey: "ialab.workspace.chatgpt.card_objectives_desc",
    action: "objetivos",
  },
  {
    icon: "M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2zM14 2v6h6",
    labelKey: "ialab.workspace.chatgpt.card_content",
    descKey: "ialab.workspace.chatgpt.card_content_desc",
    action: "contenido",
  },
  {
    icon: "M13 2 3 14h9l-1 8 10-12h-9l1-8z",
    labelKey: "ialab.workspace.chatgpt.card_activities",
    descKey: "ialab.workspace.chatgpt.card_activities_desc",
    action: "actividades",
  },
  {
    icon: "M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10zM12 8v4l3 3",
    labelKey: "ialab.workspace.chatgpt.card_practice",
    descKey: "ialab.workspace.chatgpt.card_practice_desc",
    action: "practica",
  },
];
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center gap-3 mb-8 text-center">
        ...
        <h2 className="text-2xl md:text-3xl font-bold theme-text">{t("ialab.workspace.chatgpt.heading")}</h2>
        <p className="text-sm theme-text-muted max-w-sm">
          {t("ialab.workspace.chatgpt.sub", { n: 2 })}
        </p>
      </div>
      ...
      <div className="w-full mb-6 flex gap-3">
        ...
        <div className="flex-1 space-y-2.5">
          <p className="text-sm font-semibold theme-text leading-snug">
            {t("ialab.workspace.chatgpt.intro_1")}
          </p>
          <p className="text-sm theme-text-muted leading-relaxed">
            {t("ialab.workspace.chatgpt.intro_2")}
          </p>
          <p className="text-sm theme-text-muted leading-relaxed">
            {t("ialab.workspace.chatgpt.intro_3")}
          </p>
          <p className="text-sm font-semibold theme-text leading-snug">
            {t("ialab.workspace.chatgpt.intro_4")}
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        {SUGGEST_CARDS.map(({ icon, labelKey, descKey, action }) => (
          <button
            key={labelKey}
            type="button"
            onClick={() => {
