...
export default function CourseHomeTabs({ activeTab, setActiveTab }) {
  const { t } = useTranslation();

  return (
    <div className="flex gap-1 bg-slate-200/70 rounded-xl p-1 w-fit max-md:w-full" role="tablist" aria-label="Course home tabs">
