...
import CourseHomeModuleRow from "./CourseHomeModuleRow";
...
export default function CourseHomeModuleList() {
    ...
    () =>
      MODULES.map((id) => {
        ...
        return {
          ...
          resourcesDone: !!mod?.resourcesCompleted,
          examDone: !!mod?.exam,
          challengeDone: !!mod?.challenge,
          prevModuleId: id - 1,
        };
      }),
      ...
      <div className="space-y-2.5">
        {modules.map((mod) => (
          <CourseHomeModuleRow
            ...
            score={mod.score}
            examScore={mod.examScore}
            challengeScore={mod.challengeScore}
            resourcesDone={mod.resourcesDone}
            examDone={mod.examDone}
            challengeDone={mod.challengeDone}
            prevModuleId={mod.prevModuleId}
