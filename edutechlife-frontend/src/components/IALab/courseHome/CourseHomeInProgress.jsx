...
import CourseHomeNewStudent from "./CourseHomeNewStudent";
...
function CourseHomeInProgress() {
  ...
  if (hasNoProgress) return <CourseHomeNewStudent />;
...
export default memo(CourseHomeInProgress);
