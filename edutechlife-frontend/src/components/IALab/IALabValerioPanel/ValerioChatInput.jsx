      ...
      <div className="flex items-end gap-3">
        <div className="flex-1">
          ...
          <div className="flex items-center justify-between mt-2">
            ...
            {showClearConfirm ? (
              ...
              >
                <Icon name="fa-trash" className="mr-1" />{" "}
                {t("ialab.valerio.clear_button")}
              </button>
            )}
          </div>
        </div>
        ...
        {speechSupported && (
          <button
            ...
            aria-label={
              isListening
                ? t("ialab.valerio.voice_stop_aria")
                : t("ialab.valerio.voice_start_aria")
            }
            title={
              isListening
                ? t("ialab.valerio.voice_stop_aria")
          ...
          >
            <Icon
              name={isListening ? "fa-microphone-slash" : "fa-microphone"}
              className="text-sm"
            />
          </button>
        )}
