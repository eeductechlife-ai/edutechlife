...
const ModuleHeaderSection = ({ moduleData }) => {
  return (
    <div className="relative pl-5 border-l-2 border-transparent bg-gradient-to-b from-petroleum/10 to-corporate/5 rounded-r-xl py-3 pr-4 dark:from-petroleum/20 dark:to-corporate/10"
      style={{
        borderImage: "linear-gradient(to bottom, #004B63, #00BCD4) 1",
      }}
    >
      <div className="absolute -left-[9px] top-4 w-4 h-4 rounded-full bg-gradient-to-br from-petroleum to-corporate shadow-sm flex items-center justify-center flex-shrink-0">
