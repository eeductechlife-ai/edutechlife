...
const IALabForumPostCard = ({
  ...
  return (
    <div className="bg-white rounded-2xl p-6 border border-slate-100 hover:border-[var(--theme-primary)]/20 hover:bg-slate-50 hover:shadow-[0_8px_32px_rgba(0,188,212,0.08)] transition-all duration-300 cursor-pointer">
      <div className="flex items-start gap-4 mb-6">
        <div className="flex-shrink-0">
          <div className="w-14 h-14 rounded-full bg-gradient-to-r from-[var(--theme-emphasis)] to-[var(--theme-primary)] flex items-center justify-center text-white font-bold text-lg mb-2">
          ...
          <div
            className={`text-xs font-medium px-2 py-1 rounded-full text-center ${
              simulatedData.role === "Mentor"
                ...
                : "bg-[var(--theme-emphasis)]/10 text-[var(--theme-emphasis)] border border-[var(--theme-emphasis)]/20"
            }`}
          >
            {simulatedData.role === "Mentor"
        ...
        <div className="flex-1 min-w-0">
          <div className="mb-3">
            <h4 className="font-bold text-[var(--theme-emphasis)]-darker text-lg mb-1">
          ...
          <div className="space-y-4">
            ...
            <div className="pt-3 border-t border-slate-100">
              <div className="flex items-center gap-2">
                <div className="w-6 h-6 rounded-full bg-gradient-to-r from-[var(--theme-primary)]/20 to-[var(--theme-emphasis)]/20 flex items-center justify-center text-xs font-medium text-[var(--theme-emphasis)]">
      ...
      <div className="flex items-center justify-between pt-4 border-t border-slate-100">
        <div className="flex items-center gap-3">
          <button
            ...
            className={`
                            ...
                            focus:outline-none focus:ring-1 focus:ring-[var(--theme-primary)]/30
        ...
        <div className="flex items-center gap-1">
          <button
            className="p-1.5 text-slate-600 hover:text-[var(--theme-primary)] transition-colors duration-200 rounded-md hover:bg-slate-50"
