      ...
      <div className="p-5 space-y-5">
        ...
        <div>
          ...
          <div className="h-3 bg-[#E2E8F0] rounded-full overflow-hidden">
            <motion.div className="h-full bg-gradient-to-r from-[#4DA8C4] to-[#66CCCC] rounded-full" initial={{ width: 0 }} animate={{ width: `${p}%` }} transition={{ duration: 1, ease: "easeOut" }} />
          </div>
        ...
        {materials?.length > 0 && materials.map((m, i) => <StudyPlanCard key={i} material={m} />)}
