  ...
  if (!vakResult) {
    return (
      ...
      >
        ...
        <h3 className="text-2xl font-bold text-[#004B63] mb-3">Plan Personalizado</h3>
        <p className="text-[#64748B]">
          Completa primero el <strong>Diagnóstico VAK</strong> para recibir un plan de estudio 
          hecho a tu medida.
        </p>
        <p className="text-sm text-[#4DA8C4] mt-4">
          Ve a la pestaña "Mi VAK" y responde las preguntas.
        </p>
      </motion.div>
    );
  }
    ...
    <div className="space-y-6">
      ...
      >
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            <h2 className="text-2xl font-black text-[#004B63]">Tu Plan Personalizado</h2>
            <p className="text-sm text-[#64748B]">
              Basado en tu estilo de aprendizaje{' '}
        ...
        <div className="grid grid-cols-3 gap-4 mb-6">
          {Object.entries(scores).map(([key, value]) => (
            ...
            >
              ...
              <p className="text-xs text-[#64748B] mt-1">{STYLE_NAMES[key]}</p>
            ...
            >
              <div className="flex items-center gap-2 mb-2">
                <span className="text-lg">
                  {item.time === 'Mañana' ? '🌅' : item.time === 'Tarde' ? '☀️' : '🌙'}
                </span>
                <span className="font-bold text-sm text-[#004B63]">{item.time}</span>
              </div>
