      ...
      <AnimatePresence mode="wait">
        ...
        >
          ...
          <motion.div
            ...
            className={`relative z-10 pointer-events-auto w-full sm:w-[95vw] sm:max-w-2xl md:max-w-lg max-h-[85vh] rounded-t-2xl md:rounded-2xl shadow-2xl flex flex-col overflow-hidden border ${
              darkMode
