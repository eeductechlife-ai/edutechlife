...
const PremiumSidebar = ({
  ...
  return (
    <motion.aside
      ...
      className={`hidden md:flex w-60 flex-col h-full backdrop-blur-xl border-r relative z-20 transition-colors duration-500 ${
        darkMode
          ? "bg-[#151F32]/85 border-[#2A3A54]/60"
                          ...
                          >
                            <span
                              ...
                              style={{
                                ...
                                border: isActive ? "none" : `1.5px solid ${cat.color}66`,
                              }}
                            />
