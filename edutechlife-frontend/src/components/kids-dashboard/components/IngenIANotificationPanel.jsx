...
import { SB_COLORS, SB_GRADIENTS, SB_RADII, glow } from "../ingenIATheme";

/**
 * IngenIANotificationPanel — notification dropdown styled with the IngenIA
 * design system (gradients, glow, chunky radii, emoji icons, dark mode). Reads
 * the shared NotificationContext store; on click it routes IngenIA
 * notifications to the right tab via onNavigateTab (no IALab routes).
 */

// type → emoji + accent color, drawn from the IngenIA palette
const TYPE_STYLE = {
  smartboard_mission: {
    emoji: "🎯",
...
const IngenIANotificationPanel = ({
  isOpen,
  onClose,
  triggerRef,
  darkMode = false,
...
export default IngenIANotificationPanel;
