            ...
            >
              <div className="relative z-10 flex items-center gap-3">
                ...
                <div className="min-w-0">
                  <h1 className="text-base font-bold leading-tight">IngenIA</h1>
                ...
                >
                  <div>
                    <div className="flex items-center gap-3 mb-8">
                      ...
                      <div>
                        <h1 className="text-2xl font-bold">IngenIA</h1>
                  ...
                  >
                    ...
                    <AnimatePresence mode="wait">
                      ...
                      {parentMode === "register" && (
                        ...
                        >
                          <div className="bg-[#E8F7FB] rounded-xl p-3 text-xs text-[#4DA8C4]">
                            Crea tu acceso usando el correo de tu hijo/a. El
                            estudiante genera el código de invitación desde su
                            cuenta.
                          </div>
                          <div>
                            <label className="block text-sm font-semibold text-gray-700 mb-1">
                              Código de invitación del estudiante
                            </label>
                            <div className="relative">
                              ...
                              <input
                                ...
                                onChange={handleParentChange}
                                placeholder="Código generado por tu hijo/a"
                                className="w-full pl-10 pr-4 py-2.5 border border-[#4DA8C4]/30 rounded-xl focus:ring-2 focus:ring-[#4DA8C4] focus:border-transparent text-sm"
                                required
                              />
                            </div>
