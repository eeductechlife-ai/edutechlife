    ...
    <div className="max-w-4xl mx-auto">
      <div className="grid md:grid-cols-2 gap-8">
        <div className="bg-white/70 backdrop-blur-xl border border-white/40 shadow-premium rounded-2xl p-6 md:p-8">
          <h3 className="text-lg font-bold text-petroleum mb-6">{t('automation.roi.company_data')}</h3>
        ...
        <div>
          ...
          <div className="bg-white/70 backdrop-blur-xl border border-white/40 shadow-premium rounded-2xl p-5">
            <h4 className="text-sm font-bold text-petroleum mb-4">{t('automation.roi.comparativa')}</h4>

            <div className="space-y-3">
              <div>
                <div className="flex justify-between text-xs text-slate-500 mb-1">
                  <span>{t('automation.roi.costo_actual')}</span>
                  <span className="font-semibold text-petroleum">${results.costoActual?.toLocaleString()}</span>
                </div>
                <div className="w-full bg-white/70 rounded-full h-2">
                  <div className="h-full rounded-full bg-primary-light" style={{ width: '100%' }} />
                </div>
              </div>
              <div>
                <div className="flex justify-between text-xs text-slate-500 mb-1">
                  <span>{t('automation.roi.costo_futuro')}</span>
                  <span className="font-semibold text-success">${results.costoFuturo?.toLocaleString()}</span>
                </div>
                <div className="w-full bg-white/70 rounded-full h-2">
                  <motion.div
                    initial={{ width: 0 }}
