        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 lg:pt-6 lg:pb-3">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8 lg:mb-2">
              ...
              <div className="flex gap-3 lg:gap-2">
                {socialLinks.map((social, index) => (
                  <a
                    ...
                    className="w-10 h-10 lg:w-8 lg:h-8 rounded-brand-pill flex items-center justify-center transition-all duration-300 hover:bg-brand-primary hover:scale-110 hover:shadow-lg hover:shadow-brand-primary/30"
                    style={{
            ...
            <div>
              ...
              {subscribed ? (
                <div
                  className="rounded-brand-xl p-5 text-center"
                  style={{ backgroundColor: "rgba(255, 255, 255, 0.1)" }}
                >
                  <div className="w-12 h-12 rounded-brand-pill mx-auto mb-3 flex items-center justify-center bg-brand-primary">
                ...
                >
                  <div className="relative flex-1">
                    <input
                      ...
                      className="w-full px-4 h-11 rounded-brand-md text-sm transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-brand-primary focus:border-transparent"
                      style={{
              ...
              {legalLinks.map((item, index) => (
                <React.Fragment key={index}>
                  ...
                  <button
                    ...
                    className="text-sm transition-all duration-200 lg:hover:text-brand-primary"
                    style={{
