                ...
                <div className="space-y-4">
                  <div className="group flex items-center justify-between p-3 rounded-xl font-semibold text-sm text-slate-600 transition-all duration-300 hover:bg-indigo-50/80 hover:text-indigo-700 hover:translate-x-1 hover:shadow-sm">
                    <div className="flex items-center gap-3">
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-slate-400 group-hover:text-indigo-600"><path d="M6 8a6 6 0 0 1 12 0c0 7 4 11 4 11H2s4-4 4-11"/><path d="M9.02 19a3 3 0 0 0 5.96 0"/></svg>
                      <div>
                  ...
                  <div className="group flex items-center justify-between p-3 rounded-xl font-semibold text-sm text-slate-600 transition-all duration-300 hover:bg-indigo-50/80 hover:text-indigo-700 hover:translate-x-1 hover:shadow-sm">
                    <div className="flex items-center gap-3">
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-slate-400 group-hover:text-indigo-600"><path d="M12 3a6 6 0 0 0 9 9 9 9 0 1 1-9-9Z"/></svg>
                      <div>
