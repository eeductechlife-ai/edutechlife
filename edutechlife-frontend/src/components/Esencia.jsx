...
const Esencia = memo(() => {
  ...
  const slides = [
    {
      ...
      title: t("esencia.slide_1_title"),
    },
    {
      image: "/images/edutech-carrusel-2.webp",
      title: t("esencia.slide_2_title"),
    },
    {
      image: "/images/edutech-carrusel-3.webp",
      title: t("esencia.slide_3_title"),
    },
    {
      image: "/images/edutech-carrusel-5.webp",
      title: t("esencia.slide_4_title"),
    },
    {
      image: "/images/edutech-carrusel-6.webp",
      title: t("esencia.slide_5_title"),
    },
  ...
  const values = [
    {
      icon: "fa-robot",
      text: t("esencia.value_1_title"),
      desc: t("esencia.value_1_desc"),
    },
    {
      icon: "fa-heart",
      text: t("esencia.value_2_title"),
      desc: t("esencia.value_2_desc"),
    },
    {
      icon: "fa-shield-check",
      text: t("esencia.value_3_title"),
      desc: t("esencia.value_3_desc"),
    },
    {
      icon: "fa-school",
      text: t("esencia.value_4_title"),
      desc: t("esencia.value_4_desc"),
    },
  ];
  ...
  return (
    <section id="esencia" className="relative w-full overflow-hidden bg-white">
      ...
      <div
        className="absolute bottom-0 left-[-5%] w-[400px] h-[400px] rounded-full bg-mint/10 blur-[100px] pointer-events-none animate-[pulse-slow_8s_ease-in-out_infinite]"
              ...
              >
                ...
                <div className="relative z-10">
                  <div className="w-10 h-10 md:w-12 md:h-12 rounded-xl bg-gradient-to-br from-primary-light/15 to-petroleum/10 flex items-center justify-center mb-3 group-hover:scale-110 transition-all duration-300 mx-auto border border-primary-light/20">
                    <Icon
                      name={value.icon}
                      className="text-lg md:text-xl text-petroleum group-hover:text-primary-light transition-colors duration-300"
                    />
                  </div>
                  <h4 className="text-base md:text-lg font-semibold text-petroleum mb-1 transition-all duration-300">
                    {value.text}
                  </h4>
          ...
          <div className="space-y-5">
            <div className="group bg-gradient-to-br from-petroleum to-primary-light rounded-xl p-5 text-white shadow-premium-lg hover:shadow-premium transition-all duration-500 hover:-translate-y-1">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <span className="text-xs font-normal text-primary-light uppercase tracking-widest block mb-1">
                    {t("esencia.mission_badge")}
                  </span>
                  <h3 className="text-lg md:text-xl font-normal">
                    {t("esencia.mission_title")}
                  </h3>
                </div>
              </div>
            ...
            <div className="group card-clay-white p-5">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <span className="text-xs font-normal text-primary-light uppercase tracking-widest block mb-1">
                    {t("esencia.vision_badge")}
                  </span>
                  <h3 className="text-lg md:text-xl font-normal text-petroleum">
                    {t("esencia.vision_title")}
                  </h3>
                </div>
              </div>
              ...
              <div className="mt-4 pt-3 border-t border-border-light">
                <div className="flex items-center gap-2 text-primary-light">
                  ...
                  <span className="font-normal text-xs text-petroleum">
                    {t("esencia.vision_tagline")}
                  </span>
                </div>
              </div>
            </div>
