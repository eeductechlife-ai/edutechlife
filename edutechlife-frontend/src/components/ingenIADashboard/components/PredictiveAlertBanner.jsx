...
const PredictiveAlertBanner = memo(
  ({
    ...
    const getSeverityColor = (severity) => {
      if (severity === "high")
        return "from-red-100 to-red-50 border-red-300 border-l-4 border-l-red-500";
      if (severity === "medium")
        return "from-orange-100 to-orange-50 border-orange-300 border-l-4 border-l-orange-500";
