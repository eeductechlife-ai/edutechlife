        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            ...
            },
            {
              ...
              label: "IA Lab",
              count: "Pro",
              gradient: "from-[#FF6B9D] to-[#FF8E53]",
            ...
            >
              <div
                className={`w-14 h-14 mx-auto bg-gradient-to-br ${action.gradient} rounded-xl flex items-center justify-center mb-3 group-hover:scale-110 transition-transform shadow-lg`}
              >
