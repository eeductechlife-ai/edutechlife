...
const MISSION_TEMPLATES = [
  {
    ...
    featured: true,
    collaborative: false,
    skills: ["Auto-conocimiento", "Metacognición"],
  ...
  },
  {
    ...
    description: "Analiza un documento con Valeria IA",
    type: "project",
    difficulty: "medium",
    duration: 30,
    xpReward: 150,
    ...
    featured: false,
    collaborative: true,
    skills: ["Análisis de texto", "IA aplicada"],
  ...
  {
    id: 3,
    title: "Módulo de Prompt Engineering",
    description: "Domina la comunicación con IA",
    type: "challenge",
    difficulty: "hard",
    duration: 45,
    xpReward: 200,
    ...
    featured: true,
    collaborative: false,
    skills: ["Prompt engineering", "Comunicación IA"],
  ...
  },
  {
    ...
    description: "Trabaja en equipo para resolver problemas",
    type: "collaboration",
    difficulty: "medium",
    duration: 60,
    xpReward: 180,
    ...
    featured: false,
    collaborative: true,
    skills: ["Trabajo en equipo", "Método científico"],
  ...
  },
  {
    ...
    description: "Desarrolla tu portfolio digital",
    type: "creative",
    difficulty: "expert",
    duration: 90,
    xpReward: 300,
    ...
    featured: true,
    collaborative: false,
    skills: ["Diseño digital", "Storytelling"],
...
const SUBJECT_TEMPLATES = [
  {
    ...
    description: "Domina conceptos matemáticos complejos",
    progress: 75,
    lessons: 24,
    quizzes: 12,
    xp: 1200,
  ...
  },
  {
    ...
    description: "Explora los fundamentos de la física",
    progress: 60,
    lessons: 18,
    quizzes: 9,
    xp: 900,
  ...
  },
  {
    ...
    description: "Análisis de obras contemporáneas",
    progress: 85,
    lessons: 16,
    quizzes: 8,
    xp: 800,
  ...
  },
  {
    ...
    description: "Historia desde el origen hasta hoy",
    progress: 30,
    lessons: 22,
    quizzes: 11,
    xp: 1100,
  ...
  },
  {
    ...
    description: "Estudio a nivel molecular",
    progress: 50,
    lessons: 20,
    quizzes: 10,
    xp: 1000,
...
export default function useStudentProgress() {
  ...
  const handleValeriaQuestion = useCallback(
    (question) => {
