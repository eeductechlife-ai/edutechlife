...
Sé muy técnico y detallado. Tu respuesta debe poder ser entregada a un equipo de desarrollo para su implementación.`;
  ...
  const handleDownloadPDF = async (content, title, type) => {
        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between py-4 px-6">
          <div className="flex items-center gap-4">
            ...
            >
              ...
              <span className="text-sm text-[#64748B] hover:text-white">
                {t("consultoria.b2b.back")}
              </span>
            </button>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="font-montserrat font-bold text-lg text-[#004B63]">
                  {t("consultoria.b2b.title")}
                </h1>
                <p className="text-xs text-[#64748B]">
                  {t("consultoria.b2b.subtitle")}
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="flex gap-4 mb-8">
          ...
          >
            <div className="flex items-center justify-center gap-4">
              <div
                className={`w-12 h-12 rounded-xl flex items-center justify-center ${activeTool === "roi" ? "bg-white/20" : "bg-[#4DA8C4]/10"}`}
              >
                <i
                  className={`fa-solid fa-chart-line text-2xl ${activeTool === "roi" ? "text-white" : "text-[#4DA8C4]"}`}
                />
              </div>
              <div className="text-left">
                <div className="font-montserrat font-bold text-lg">
                  {t("consultoria.b2b.roi_tab_title")}
                </div>
                <div
                  className={`text-sm ${activeTool === "roi" ? "text-white/80" : "text-[#64748B]"}`}
                >
                  {t("consultoria.b2b.roi_tab_desc")}
                </div>
              </div>
            </div>
            {activeTool === "roi" && (
          ...
          >
            <div className="flex items-center justify-center gap-4">
              <div
                className={`w-12 h-12 rounded-xl flex items-center justify-center ${activeTool === "automation" ? "bg-white/20" : "bg-[#66CCCC]/10"}`}
              >
                <i
                  className={`fa-solid fa-sitemap text-2xl ${activeTool === "automation" ? "text-white" : "text-[#66CCCC]"}`}
                />
              </div>
              <div className="text-left">
                <div className="font-montserrat font-bold text-lg">
                  {t("consultoria.b2b.auto_tab_title")}
                </div>
                <div
                  className={`text-sm ${activeTool === "automation" ? "text-white/80" : "text-[#64748B]"}`}
                >
                  {t("consultoria.b2b.auto_tab_desc")}
                </div>
              </div>
            </div>
            {activeTool === "automation" && (
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="p-6 bg-white border border-[#E2E8F0] rounded-2xl shadow-sm hover:shadow-lg transition-shadow">
            ...
            <h3 className="font-montserrat font-bold text-[#004B63] mb-2">
              {t("consultoria.b2b.feature1_title")}
            </h3>
            <p className="text-sm text-[#64748B]">
              {t("consultoria.b2b.feature1_desc")}
            </p>
          </div>
          <div className="p-6 bg-white border border-[#E2E8F0] rounded-2xl shadow-sm hover:shadow-lg transition-shadow">
            ...
            <h3 className="font-montserrat font-bold text-[#004B63] mb-2">
              {t("consultoria.b2b.feature2_title")}
            </h3>
            <p className="text-sm text-[#64748B]">
              {t("consultoria.b2b.feature2_desc")}
            </p>
          </div>
          <div className="p-6 bg-white border border-[#E2E8F0] rounded-2xl shadow-sm hover:shadow-lg transition-shadow">
            ...
            <h3 className="font-montserrat font-bold text-[#004B63] mb-2">
              {t("consultoria.b2b.feature3_title")}
            </h3>
            <p className="text-sm text-[#64748B]">
              {t("consultoria.b2b.feature3_desc")}
            </p>
          </div>
        </div>
      </div>
