          ...
          <div className="vak-test-container">
            {showDiagnostico ? (
              ...
              <div className="vak-results-ready">
                <p>
                  Ya completaste el test. Ve a "Mi Perfil" para ver tus
                  resultados.
                </p>
                <button
        ...
        {activeTab === "testimonios" && (
          <div className="testimonios-vak-section">
            <div className="testimonios-header-vak">
              ...
              <p>
                Descubre cómo la metodología VAK ha cambiado la forma de
                aprender de miles de estudiantes y docentes
              </p>
            </div>
