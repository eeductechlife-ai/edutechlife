...
export const testimoniosVAK = [
  {
    ...
    texto:
      "Gracias a la metodología VAK y el test del Neuro-Entorno pude transformar mis clases. Ahora llegan a estudiantes que antes no conectaban con el contenido. Mis resultados en pruebas Saber mejoraron un 35%.",
  ...
  },
  {
    ...
    texto:
      "El ADN de Aprendizaje me reveló que soy kinestésico. Nunca lo había considerado, pero ahora estudio de forma completamente diferente y mis calificaciones subieron notablemente.",
  ...
  },
  {
    ...
    texto:
      "Implementamos el programa en toda la institución. Los docentes ahora comprenden cómo aprenden sus estudiantes y adaptan sus metodologías. Es revolucionario.",
  ...
  },
  {
    ...
    texto:
      "Como estudiante universitario, el coaching con MAX me ayudó a organizar mi tiempo y descubrir que soy un aprendiz multimodal. Las estrategias personalizadas marcaron la diferencia.",
...
export const features = [
  {
    icon: "fa-brain",
    title: "ADN de Aprendizaje Automatizado",
    desc: "10 preguntas científico-pedagógicas que determinan tu perfil de aprendizaje",
  },
  {
    icon: "fa-user-check",
    title: "Perfil Personalizado",
    desc: "Análisis profundo con porcentajes de cada estilo de aprendizaje",
  },
  {
    icon: "fa-book-open",
    title: "Contenido Adaptado",
    desc: "Recursos educativos diseñados para tu perfil específico",
  },
  {
    icon: "fa-chart-line",
    title: "Seguimiento Neuro",
    desc: "Métricas de progreso basadas en indicadores neurocognitivos",
  },
];
