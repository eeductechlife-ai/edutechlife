  ...
  return (
    <div className="relative w-full min-h-[70vh] flex flex-col items-center justify-center overflow-hidden bg-gradient-to-br from-[#B2D8E5] via-[#E8F4F8] to-[#B2D8E5]">
      ...
      >
        ...
        <div
          className="absolute -bottom-1 -left-1 w-2 h-2 bg-[#66CCCC] rounded-full opacity-0 group-hover:opacity-100 group-hover:animate-[sparkle_1s_ease-in-out]"
      ...
      <FloatingParticles
        count={35}
        className="z-0"
        colors={["#004B63", "#2D7A94", "#0B2A3A"]}
      />

      <div
        className="absolute top-[10%] left-[5%] w-4 h-4 bg-[#004B63]/30 rounded-full animate-[float-3d_8s_ease-in-out_infinite] blur-sm"
        style={{ animationDelay: "-2s" }}
      />
      <div
        className="absolute top-[20%] left-[15%] w-3 h-3 bg-[#2D7A94]/25 rounded-full animate-[float-3d_10s_ease-in-out_infinite] blur-sm"
        style={{ animationDelay: "-1s" }}
      />
      <div
        className="absolute bottom-[25%] left-[10%] w-5 h-5 bg-[#0B2A3A]/20 rounded-full animate-[float-3d_12s_ease-in-out_infinite] blur-sm"
        ...
        <div className="flex flex-col lg:flex-row gap-6 lg:gap-8 items-start justify-center w-full">
          ...
          >
            <div className="relative backdrop-blur-xl bg-gradient-to-br from-white/30 to-white/10 border-2 border-white/30 rounded-2xl p-4 shadow-premium-md">
              ...
              >
                ...
                <div
                  className="absolute -bottom-1 -left-1 w-2 h-2 bg-white rounded-full animate-[sparkle_1s_ease-in-out]"
                  style={{ animationDelay: "0.3s" }}
                />
              </motion.div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-4">
                <motion.div
                  ...
                  style={{
                    background:
                      "linear-gradient(135deg, #004B63 0%, #2D7A94 100%)",
                ...
                >
                  ...
                  <div className="text-white font-bold text-sm uppercase tracking-[0.15em] group-hover:tracking-[0.2em] transition-all duration-500">
                    VISUAL
                  </div>
                ...
                <motion.div
                  ...
                  style={{
                    background:
                      "linear-gradient(135deg, #2D7A94 0%, #004B63 100%)",
                ...
                <motion.div
                  ...
                  style={{
                    background:
                      "linear-gradient(135deg, #0B2A3A 0%, #004B63 100%)",
              ...
              <MagneticButton
                ...
                style={{
                  background:
                    "linear-gradient(135deg, #FFFFFF 0%, #F8FDFF 50%, #E8F4F8 100%)",
                  color: "#004B63",
              ...
              >
                ...
                >
                  ...
                  <span className="text-[#004B63] font-bold text-sm">
                    3 min
                  </span>
                </motion.div>
          ...
          >
            <div className="p-4">
              ...
              >
                VAK es un modelo neuropsicológico que identifica cómo procesa
                información cada persona de manera única.
              </motion.p>
              ...
              <ul className="space-y-4 mb-6">
                ...
                >
                  <div className="relative flex-shrink-0">
                    ...
                    <div
                      className="absolute -bottom-1 -left-1 w-2 h-2 bg-white rounded-full animate-[float-mini_4s_ease-in-out_infinite] opacity-0 group-hover:opacity-100"
                      style={{ animationDelay: "0.5s" }}
                    />
                  </div>
                  <div className="pt-1 flex-1">
                    <div className="flex items-center gap-2 mb-0.5">
                      <span className="font-bold text-base text-[#004B63] group-hover:text-[#0B2A3A] transition-colors duration-500">
                        Visual:
                      </span>
                    ...
                    <p className="text-[#004B63]/90 text-sm leading-relaxed font-medium group-hover:text-[#004B63] transition-colors duration-500">
                      Aprende mejor con imágenes, gráficos y contenido visual
                      organizado
                    </p>
                  </div>
                </motion.li>
                ...
                >
                  <div className="relative flex-shrink-0">
                    <div
                      className="absolute inset-0 w-14 h-14 bg-gradient-to-r from-[#66CCCC] to-[#4DA8C4] rounded-xl blur-md opacity-60 group-hover:opacity-80 transition-opacity duration-500 animate-[float-3d_7s_ease-in_out_infinite]"
                      style={{ animationDelay: "0.5s" }}
                    />
                    <div className="relative w-14 h-14 rounded-xl bg-gradient-to-br from-white/30 to-white/10 backdrop-blur-md border-2 border-white/40 flex items-center justify-center shadow-premium-lg group-hover:shadow-premium-xl transition-all duration-500">
                      <div className="absolute inset-0 bg-gradient-to-t from-transparent via-white/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-700 rounded-xl" />
                  ...
                  <div className="pt-1 flex-1">
                    <div className="flex items-center gap-2 mb-0.5">
                      ...
                      <div
                        className="w-1.5 h-1.5 bg-[#66CCCC] rounded-full animate-[pulse_2s_ease-in-out_infinite] opacity-0 group-hover:opacity-100 transition-opacity duration-500"
                        style={{ animationDelay: "0.3s" }}
                      />
                    </div>
                    <p className="text-[#004B63]/90 text-sm leading-relaxed font-medium group-hover:text-[#004B63] transition-colors duration-500">
                      Aprende mejor con sonidos, explicaciones verbales y
                      discusiones
                    </p>
                  </div>
                </motion.li>
                ...
                >
                  <div className="relative flex-shrink-0">
                    <div
                      className="absolute inset-0 w-14 h-14 bg-gradient-to-r from-[#B2D8E5] to-[#66CCCC] rounded-xl blur-md opacity-60 group-hover:opacity-80 transition-opacity duration-500 animate-[float-3d_8s_ease-in-out_infinite]"
                      style={{ animationDelay: "1s" }}
                    />
                    <div className="relative w-14 h-14 rounded-xl bg-gradient-to-br from-white/30 to-white/10 backdrop-blur-md border-2 border-white/40 flex items-center justify-center shadow-premium-lg group-hover:shadow-premium-xl transition-all duration-500">
                      <div className="absolute inset-0 bg-gradient-to-t from-transparent via-white/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-700 rounded-xl" />
                  ...
                  <div className="pt-1 flex-1">
                    <div className="flex items-center gap-2 mb-0.5">
                      ...
                      <div
                        className="w-1.5 h-1.5 bg-[#B2D8E5] rounded-full animate-[pulse_2s_ease-in-out_infinite] opacity-0 group-hover:opacity-100 transition-opacity duration-500"
                        style={{ animationDelay: "0.6s" }}
                      />
                    </div>
                    <p className="text-[#004B63]/90 text-sm leading-relaxed font-medium group-hover:text-[#004B63] transition-colors duration-500">
                      Aprende mejor con experiencias prácticas, movimiento y
                      manipulación
                    </p>
                  </div>
                </motion.li>
              ...
              >
                <div className="relative p-4 rounded-xl bg-gradient-to-br from-white/40 to-white/10 backdrop-blur-lg border border-white/30 shadow-premium-lg">
                  <div className="absolute top-2 left-3 text-3xl text-[#4DA8C4]/30 font-serif">
                    "
                  </div>
                  <div className="absolute bottom-2 right-3 text-3xl text-[#66CCCC]/30 font-serif">
                    "
                  </div>
                  ...
                  <p className="text-sm italic text-center font-medium text-[#0B2A3A] leading-relaxed px-4">
                    <span className="font-semibold text-[#004B63]">
                      Conocer tu estilo VAK
                    </span>{" "}
                    te permite estudiar de forma más eficiente y personalizada,
                  ...
                  <div className="flex justify-center gap-2 mt-3">
                    ...
                    <div
                      className="w-1.5 h-1.5 bg-[#66CCCC] rounded-full animate-[pulse_1.5s_ease-in-out_infinite]"
                      style={{ animationDelay: "0.2s" }}
                    />
                    <div
                      className="w-1.5 h-1.5 bg-[#B2D8E5] rounded-full animate-[pulse_1.5s_ease-in-out_infinite]"
