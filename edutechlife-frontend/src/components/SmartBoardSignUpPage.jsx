                  ...
                  {mode === "signin" ? (
                    <p
                      ...
                      dangerouslySetInnerHTML={{
                        __html: sanitize(t("smartboard.signup_signin_desc")),
                      }}
                    />
                  ) : (
                    <p
                      className="text-white/90 leading-relaxed"
                      dangerouslySetInnerHTML={{
                        __html: sanitize(t("smartboard.signup_signup_desc")),
                      }}
                    />
                  )}
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-white/90">
                      {t("smartboard.signup_feature_missions")}
                    </span>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 bg-white/20 rounded-lg flex items-center justify-center">
                    ...
                    <span className="text-white/90">
                      {t("smartboard.signup_feature_community")}
                    </span>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 bg-white/20 rounded-lg flex items-center justify-center">
                    ...
                    <span className="text-white/90">
                      {t("smartboard.signup_feature_tracking")}
                    </span>
                  </div>
                </div>
              </div>
