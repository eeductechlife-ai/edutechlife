...
const Hero = memo(() => {
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute top-[15%] left-[10%] w-3 h-3 bg-primary-light/15 rounded-full animate-[float-3d_6s_ease-in-out_infinite]"
        style={{ animationDelay: "-2s" }}
      />
      <div
        className="absolute bottom-[30%] left-[20%] w-2 h-2 bg-mint/12 rounded-full animate-[float-3d_7s_ease-in-out_infinite]"
        style={{ animationDelay: "-1s" }}
      />
      <div
        className="absolute top-[50%] left-[5%] w-2 h-2 bg-soft-blue/10 rounded-full animate-[float-3d_8s_ease-in-out_infinite]"
        ...
        <div className="flex flex-col items-center justify-center text-center">
          ...
          >
            ...
            >
              <Icon
                name="fa-chalkboard"
                className="text-petroleum group-hover:text-white transition-colors duration-300"
              />
