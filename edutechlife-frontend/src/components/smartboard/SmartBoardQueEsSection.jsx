...
export default function SmartBoardQueEsSection({ t }) {
  return (
    <section id="que-es" className="relative w-full overflow-hidden bg-white py-12 lg:py-16 scroll-mt-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          >
            <motion.div {...fadeInUp} className="text-left">
              ...
              <h2 className="text-2xl md:text-3xl lg:text-4xl font-black text-petroleum leading-tight">
                {t('smartboard.landing_what_title_line1')}<br />
                <span className="text-gradient-accent pr-1">{t('smartboard.landing_what_title_line2')}</span>
              </h2>
            </motion.div>
          ...
          >
            <motion.div
              ...
              className="rounded-2xl bg-petroleum/5 border border-petroleum/10 overflow-hidden relative shadow-premium-lg"
            >
              <div className="aspect-video w-full bg-petroleum-dark/10 flex items-center justify-center">
                <video className="w-full h-full object-contain" src="/smarboard.mov" autoPlay muted loop playsInline controls preload="metadata" />
              </div>
            ...
            <div className="mt-4 card-clay-white bg-white rounded-xl shadow-premium border border-petroleum/10 p-3 self-start">
              <div className="flex items-center gap-2">
                <div className="w-8 h-8 rounded-full bg-success/10 flex items-center justify-center">
                  <Icon name="fa-check-circle" className="text-success text-sm" />
                </div>
                <div>
