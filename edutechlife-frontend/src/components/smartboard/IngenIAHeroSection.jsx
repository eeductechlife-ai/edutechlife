...
import IngenIATilt3D from "./IngenIATilt3D";
import IngenIAVakBadge from "./IngenIAVakBadge";

IngenIAHeroSection.propTypes = {
...
export default function IngenIAHeroSection({
  t,
  onBack,
  inView,
  countStudents,
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 lg:px-8 py-8 lg:py-10">
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-2 hidden lg:flex flex-col items-center justify-center gap-4">
            ...
            >
              {STATS.map((stat, i) => (
                <IngenIATilt3D key={i} intensity={12}>
                  <motion.div
