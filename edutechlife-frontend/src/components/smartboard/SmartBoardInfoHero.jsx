...
import { containerVariants, childVariant } from "./SmartBoardShared";
...
export default function SmartBoardInfoHero({ handleCta, onNavigate }) {
        ...
        <div className="mt-6 grid grid-cols-1 items-center gap-10 lg:mt-8 lg:grid-cols-12 lg:gap-10">
          ...
          >
            <motion.div
              ...
              animate={reduce ? false : { opacity: [0.35, 0.65, 0.35], scale: [1, 1.06, 1] }}
            ...
            >
              <circle cx="250" cy="250" r="220" stroke="rgba(77,168,196,0.4)" strokeWidth="1.5" />
              <motion.circle
                cx="250"
                cy="250"
                r="196"
            ...
            <motion.img
              ...
              alt="Estudiante de Edutechlife aprendiendo con SmartBoard"
              loading="lazy"
            ...
            {ORBIT_ICONS.map((badge, i) => (
              ...
              >
                <Icon name={badge.icon} className="h-5 w-5 text-primary-light sm:h-6 sm:w-6" />
              </motion.span>
            ))}
          </motion.div>
        </div>
