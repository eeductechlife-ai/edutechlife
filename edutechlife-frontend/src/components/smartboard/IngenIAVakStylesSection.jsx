...
export default function IngenIAVakStylesSection({ t, vakStyles }) {
  const prefersReducedMotion = useReducedMotion();
  return (
    <section
      id="estilos-vak"
      role="region"
      aria-label="Estilos de aprendizaje VAK"
      className="relative w-full overflow-hidden bg-gradient-to-b from-petroleum/3 to-white py-12 lg:py-16 scroll-mt-20"
    >
        ...
        >
          {vakStyles.map((style, idx) => (
            <motion.div
              ...
              className="group relative card-clay-white bg-white rounded-2xl border border-white/40 shadow-sm hover:shadow-premium-lg transition-all duration-500 overflow-hidden"
            >
              <div
              ...
              <div className="p-5 lg:p-6">
                ...
                <h3 className="text-base font-bold text-petroleum mb-2">
                  {style.title}
                </h3>
...
IngenIAVakStylesSection.propTypes = {
