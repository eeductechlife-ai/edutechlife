...
const Aliados = memo(() => {
  ...
  const aliados = [
    {
      id: 1,
      name: "SENA",
      category: t("aliados.category_sena"),
      icon: GraduationCap,
      color: "#004B63",
    },
    {
      id: 2,
      name: "UNESCO",
      category: t("aliados.category_unesco"),
      icon: Globe,
      color: "#4DA8C4",
    },
    {
      id: 3,
      name: "Ministerio",
      category: t("aliados.category_ministerio"),
      icon: Building2,
      color: "#66CCCC",
    },
    {
      id: 4,
      name: "Google",
      category: t("aliados.category_google"),
      icon: Search,
      color: "#004B63",
    },
    {
      id: 5,
      name: "Microsoft",
      category: t("aliados.category_microsoft"),
      icon: Cloud,
      color: "#4DA8C4",
    },
    {
      id: 6,
      name: "AWS",
      category: t("aliados.category_aws"),
      icon: Cloud,
      color: "#66CCCC",
    },
    {
      id: 7,
      name: "ICETEX",
      category: t("aliados.category_icetex"),
      icon: Award,
      color: "#004B63",
    },
    {
      id: 8,
      name: "Colciencias",
      category: t("aliados.category_colciencias"),
      icon: FlaskConical,
      color: "#4DA8C4",
    },
    {
      id: 9,
      name: "Apple",
      category: t("aliados.category_apple"),
      icon: Laptop,
      color: "#66CCCC",
    },
    {
      id: 10,
      name: "IBM",
      category: t("aliados.category_ibm"),
      icon: Cpu,
      color: "#004B63",
    },
    {
      id: 11,
      name: "Coursera",
      category: t("aliados.category_coursera"),
      icon: Sparkles,
      color: "#4DA8C4",
    },
    {
      id: 12,
      name: "Steam",
      category: t("aliados.category_steam"),
      icon: Cpu,
      color: "#66CCCC",
    },
  ];
  ...
  return (
    <section
      id="aliados"
      ref={sectionRef}
      className="relative w-full py-12 lg:py-16 overflow-hidden bg-white"
    >
              ...
              {duplicatedAliados.map((aliado, index) => (
                ...
                >
                  ...
                  <div className="flex flex-col">
                    <span className="font-bold text-[#004B63] group-hover:text-primary-light transition-colors duration-300">
                      {aliado.name}
                    </span>
