      ...
      >
        ...
        >
          ...
          <div className="px-6 md:px-10 py-6 space-y-6">
            <div className="flex items-center gap-4">
              <div
                ...
                style={footerLighterBg}
              >
                <Icon
                  name={
                    helpArticles.find((d) => d.id === selectedDoc)?.icono ||
                    "fa-file"
                  }
                  className="text-xl"
              ...
              <div>
                <h1 className="text-2xl font-bold" style={footerPrimaryText}>
                  {doc.titulo}
                </h1>
                <p className="text-sm" style={footerAccentText}>
                  {helpArticles.find((d) => d.id === selectedDoc)?.tiempo}{" "}
                  {{ en: "read", pt: "de leitura", es: "de lectura" }[locale]}
                </p>
              </div>
            </div>

            <p className="text-lg leading-relaxed" style={footerDarkText}>
              {doc.introduccion}
            </p>
            ...
            {doc.secciones.map((seccion, idx) => (
              <div key={idx} className="space-y-4">
                      ...
                      <tbody>
                        {seccion.especificacion.map((spec, i) => (
                          ...
                          >
                            ...
                            <td className="py-2" style={footerDarkText}>
                              {spec.valor}
                            </td>
                          </tr>
                        ))}
                  ...
                  <div className="space-y-3">
                    {seccion.modelos.map((modelo, i) => (
                      <div
                        ...
                        style={footerLightBg}
                      >
                        <h4 className="font-semibold" style={footerPrimaryText}>
                          {modelo.nombre}
                        </h4>
                ...
                {seccion.grafica === "linea" &&
                  renderLineChart(seccion, locale)}
                  ...
                  <div className="space-y-4">
                    {seccion.faqs.map((faq, i) => (
                      ...
                      >
                        ...
                        <p className="text-sm" style={footerDarkText}>
                          {faq.a}
                        </p>
                      </div>
                    ))}
          ...
          >
            ...
            >
              {{ en: "Back", pt: "Voltar", es: "Volver" }[locale]}
            </button>
          </div>
        </div>
      </div>
        ...
        <div className="space-y-4">
          ...
          {helpArticles.map((doc, index) => (
            ...
            >
              ...
              <div className="flex items-center gap-2">
                <span className="text-xs" style={footerAccentText}>
                  {doc.tiempo}
                </span>
                <Icon
    ...
    <div className="p-4 rounded-xl" style={{ backgroundColor: "#F3F9FB" }}>
      ...
      <div className="flex items-end justify-between h-40 gap-2">
        {seccion.datos.map((d, i) => {
          const max = Math.max(
            ...seccion.datos.map((x) => x.engagement || x.valor || 100),
          );
  ...
  return (
    <div className="p-4 rounded-xl" style={{ backgroundColor: "#F3F9FB" }}>
      ...
      <div className="space-y-3">
        {seccion.datos.map((d, i) => {
          const max = Math.max(
            ...seccion.datos.map((x) => x.antes || x.despues || x.valor || 100),
          );
  ...
  return (
    ...
    >
      <div>
        ...
        <p className="font-mono text-sm" style={{ color: "#004B63" }}>
          {seccion.detalle.base}
        </p>
      </div>
      <div>
        <span className="text-xs" style={{ color: "#6B7280" }}>
            ...
            <tr key={i} className="border-b" style={{ borderColor: "#E5E7EB" }}>
              ...
              <td className="px-4 py-2">
                <span
                  ...
                  style={{
                    backgroundColor:
                      int.estado === "Production" || int.estado === "Producción"
                        ? "#DCFCE7"
                        : "#FEF3C7",
                    color:
                      int.estado === "Production" || int.estado === "Producción"
