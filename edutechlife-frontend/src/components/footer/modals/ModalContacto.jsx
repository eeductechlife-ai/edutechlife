...
export default function ModalContacto({ onClose }) {
  ...
  if (submitted) {
    return (
      <div
        ...
        role="dialog"
        aria-modal="true"
        aria-label={t("footer.contact_modal.success_title")}
        className="fixed inset-0 z-[100] flex items-center justify-center p-2 md:p-4"
        onClick={handleClose}
      >
        <div className="absolute inset-0 bg-black/70 backdrop-blur-sm" />
        <div
          className="relative w-full max-w-md mx-4 overflow-hidden rounded-2xl bg-white"
        ...
        >
          <div className="p-8 text-center">
            ...
            <h3 className="text-xl font-bold mb-2" style={footerPrimaryText}>
              {t("footer.contact_modal.success_title")}
            </h3>
            <p className="text-gray-600 mb-6">
              {t("footer.contact_modal.success_desc")}
            </p>
            <button
              onClick={handleClose}
  ...
  return (
    <div
      ...
      role="dialog"
      aria-modal="true"
      aria-label={t("header.contact_us")}
      className="fixed inset-0 z-[100] flex items-center justify-center p-2 md:p-4"
      onClick={handleClose}
    >
      <div className="absolute inset-0 bg-black/70 backdrop-blur-sm" />
      <div
        className="relative w-full max-w-2xl mx-4 overflow-hidden rounded-2xl max-h-[90vh] overflow-y-auto bg-white"
        onClick={(e) => e.stopPropagation()}
      >
        <div
        ...
        >
          <button
            onClick={handleClose}
            aria-label="Cerrar"
            className="absolute top-2 right-2 p-2.5 transition-colors"
            style={{ color: "#9CA3AF" }}
          ...
          <div className="flex items-center gap-3">
            ...
            />
            <div>
              <h3 className="text-xl font-bold" style={footerPrimaryText}>
                {t("header.contact_us")}
              </h3>
        ...
        <div className="p-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-4">
              <h4 className="font-bold" style={footerPrimaryText}>
                {t("footer.contact_modal.contact_info")}
              </h4>
              <div className="space-y-3">
                ...
                >
                  ...
                  <div>
                    <p className="text-xs" style={footerMutedText}>
                      {t("footer.contact_modal.email")}
                    </p>
                    <p
                      className="text-sm font-medium"
                      style={footerPrimaryText}
                    >
                      {t("footer.contact_email_text")}
                    </p>
                  </div>
                </div>
                <div
                ...
                >
                  ...
                  <div>
                    <p className="text-xs" style={footerMutedText}>
                      {t("footer.contact_modal.phone")}
                    </p>
                    <p
                      className="text-sm font-medium"
                      style={footerPrimaryText}
                    >
                      {t("footer.contact_phone_text")}
                    </p>
                  </div>
                </div>
                <div
                ...
                >
                  ...
                  <div>
                    <p className="text-xs" style={footerMutedText}>
                      {t("footer.contact_modal.address")}
                    </p>
                    <p
                      className="text-sm font-medium"
                      style={footerPrimaryText}
                    >
                      {t("footer.contact_address_text")}
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="p-4 rounded-xl" style={footerLighterBg}>
                <h5 className="font-semibold mb-2" style={footerPrimaryText}>
                  {t("footer.contact_modal.schedule_title")}
                </h5>
                <div className="space-y-1 text-sm">
                  <div className="flex justify-between">
                    <span style={footerDarkText}>
                      {t("footer.contact_modal.mon_fri")}
                    </span>
                    <span style={footerMutedText}>9:00 - 18:00</span>
                  </div>
                  <div className="flex justify-between">
                    <span style={footerDarkText}>
                      {t("footer.contact_modal.saturday")}
                    </span>
                    <span style={footerMutedText}>10:00 - 14:00</span>
                  </div>
                  <div className="flex justify-between">
                    <span style={footerDarkText}>
                      {t("footer.contact_modal.sunday")}
                    </span>
                    <span style={footerMutedText}>
                      {t("footer.contact_modal.closed")}
                    </span>
                  </div>
                  <div
                  ...
                  >
                    <span style={{ color: "#004B63", fontWeight: "600" }}>
                      {t("footer.contact_modal.live_chat")}
                    </span>
              ...
              <div>
                <h5 className="font-semibold mb-2" style={footerPrimaryText}>
                  {t("footer.contact_modal.follow_us")}
                </h5>
            ...
            <div>
              <h4 className="font-bold mb-4" style={footerPrimaryText}>
                {t("footer.contact_modal.form_title")}
              </h4>
              <form onSubmit={handleSubmit} className="space-y-3">
                <div>
                  <label
                    htmlFor="footer-nombre"
                    className="block text-sm font-semibold mb-1"
                    style={footerPrimaryText}
                  >
                    {t("footer.contact_modal.label_name")}
                  </label>
                  <input
                    type="text"
                    id="footer-nombre"
                    ...
                    placeholder={t("footer.contact_modal.placeholder_name")}
                ...
                <div>
                  <label
                    ...
                    style={footerPrimaryText}
                  >
                    {t("footer.contact_modal.label_email")}
                  </label>
                  <input
                    type="email"
                    id="footer-email"
                    ...
                    placeholder={t("footer.contact_modal.placeholder_email")}
                    onFocus={(e) => (e.target.style.borderColor = "#4DA8C4")}
                    onBlur={(e) => (e.target.style.borderColor = "#E5E7EB")}
                    autoComplete="email"
                  />
                ...
                <div>
                  <label
                    htmlFor="footer-telefono"
                    className="block text-sm font-semibold mb-1"
                    style={footerPrimaryText}
                  >
                    {t("footer.contact_modal.label_phone")}
                  </label>
                  <input
                    type="tel"
                    id="footer-telefono"
                    ...
                    placeholder={t("footer.contact_modal.placeholder_phone")}
                    onFocus={(e) => (e.target.style.borderColor = "#4DA8C4")}
                    onBlur={(e) => (e.target.style.borderColor = "#E5E7EB")}
                    autoComplete="tel"
                  />
                ...
                <div>
                  <label
                    htmlFor="footer-motivo"
                    className="block text-sm font-semibold mb-1"
                    style={footerPrimaryText}
                  >
                    {t("footer.contact_modal.label_reason")}
                  </label>
                  <select
                    id="footer-motivo"
                    name="motivo"
                    ...
                    onChange={handleChange}
                    className="w-full px-4 py-2.5 rounded-xl text-sm bg-white"
                    style={{
                      border: "2px solid #E5E7EB",
                      color: "#004B63",
                      outline: "none",
                  ...
                  >
                    <option value="">
                      {t("footer.contact_modal.reason_placeholder")}
                    </option>
                    <option value="informacion">
                      {t("footer.contact_modal.reason_info")}
                    </option>
                    <option value="diagnostico">
                      {t("footer.contact_modal.reason_vak")}
                    </option>
                    <option value="cursos">
                      {t("footer.contact_modal.reason_courses")}
                    </option>
                    <option value="consultoria">
                      {t("footer.contact_modal.reason_consulting")}
                    </option>
                    <option value="otro">
                      {t("footer.contact_modal.reason_other")}
                    </option>
                  </select>
                </div>
                <button
                  ...
                  onMouseEnter={(e) =>
                    (e.currentTarget.style.boxShadow =
                      "0 6px 20px rgba(77, 168, 196, 0.5)")
                  }
                  onMouseLeave={(e) =>
                    (e.currentTarget.style.boxShadow =
                      "0 4px 15px rgba(77, 168, 196, 0.3)")
                  }
                >
