        ...
        <div className="p-6">
          {submitted ? (
            <div className="text-center py-12">
              ...
              <h4 className="text-xl font-bold text-petroleum mb-2">
                {t("metodo.success_title")}
              </h4>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <label className="block text-sm font-semibold text-petroleum mb-1.5">
                  {t("metodo.form_name_label")}{" "}
              ...
              <div>
                ...
                >
                  ...
                  <option value="Cursos STEAM">
                    {t("metodo.form_option_steam")}
                  </option>
                  <option value="Tutorías Personalizadas">
