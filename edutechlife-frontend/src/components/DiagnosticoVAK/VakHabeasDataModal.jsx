...
// Modal de Política de Tratamiento de Datos Personales (Habeas Data) del Diagnóstico VAK.
// onClose: cierra el modal sin aceptar. onAccept: marca la aceptación y cierra el modal.
const VakHabeasDataModal = ({ onClose, onAccept }) => {
...
export default VakHabeasDataModal;
