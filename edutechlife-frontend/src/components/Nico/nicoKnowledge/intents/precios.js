export const precios = [
  ...
  },
  {
    ...
    category: "precios",
    response:
      "El acompañamiento académico se ofrece dentro de nuestros programas (IALab para IA y IngenIA para niños y jóvenes, con el tutor Dani). El valor depende del plan; escríbenos por WhatsApp +57 323 836 5517 y te enviamos la cotización vigente en pesos colombianos. La primera clase es gratuita.",
  },
  {
    ...
    category: "precios",
    response:
      "El bienestar y el acompañamiento emocional están integrados en IngenIA (apoyo a niños y jóvenes con detección de señales de alerta). Los planes se publican en pesos colombianos; por WhatsApp te damos el detalle vigente.",
  },
  {
    id: "precios_ingles",
    patterns: [
