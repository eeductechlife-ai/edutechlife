...
const LeadCaptureForm = ({
  ...
  if (isSuccess) {
    return (
      <div
        className="animate-fadeIn p-6 rounded-xl"
      ...
      >
        <div className="flex flex-col items-center justify-center text-center">
          ...
          <p className="mb-4" style={{ color: COLORS.NAVY }}>
            ...
            <strong>{formData.interesPrincipal || "nuestros servicios"}</strong>
            .
          </p>
          <div className="bg-white/80 p-4 rounded-lg mb-4">
            <p className="font-medium mb-2" style={{ color: COLORS.PETROLEUM }}>
              Próximos pasos:
            </p>
            <ul
            ...
            >
              ...
              <li>
                ✅ Recibirás información detallada por{" "}
  ...
  return (
    <div
      className="animate-slideUp p-4 rounded-xl border-2"
      style={{
    ...
    >
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="relative">
            ...
            <input
              ...
              style={{
                ...
                borderColor: errors.nombreCompleto
                  ? "#ef4444"
                  : COLORS.CORPORATE,
                color: COLORS.NAVY,
        ...
        <p
          ...
          style={{ color: COLORS.PETROLEUM }}
        >
          Tus datos están seguros. Solo los usaremos para contactarte sobre
          EdutechLife.
        </p>
      </form>
    </div>
