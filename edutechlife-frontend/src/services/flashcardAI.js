...
export function detectCardIcon(keyword) {
  ...
  const iconMap = {
    ...
    // Educación Física / Deportes / Salud
    deporte: "⚽",
    deportes: "⚽",
    "educación física": "🏃",
    "educacion fisica": "🏃",
  ...
  // 1) Coincidencia exacta de toda la frase
  if (iconMap[keywordLower]) {
    return iconMap[keywordLower];
  }

  // 2) Coincidencia por palabra completa (evita falsos positivos como
  //    "comparar" -> "par"). Se prioriza la palabra más larga.
  ...
  // 3) Coincidencia de subcadena solo para claves largas (>= 5),
  //    y para claves multi-palabra contenidas en el keyword.
