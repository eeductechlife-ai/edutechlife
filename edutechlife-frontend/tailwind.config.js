  ...
  theme: {
    ...
    extend: {
        colors: {
         ...
         'brand-accent': '#00BCD4',
          petroleum: '#004B63',
          'petroleum-dark': '#0A3550',
          'petroleum-darker': '#00374A',
          corporate: '#00BCD4',
          'corporate-dark': '#0097A7',
          'corporate-darker': '#00A5B8',
          'corporate-deep': '#003A4D',
         'soft-blue': '#B2D8E5',
         mint: '#66CCCC',
         navy: '#0A1628',
      ...
      backgroundColor: {
        ...
        'petroleum-darker': 'var(--color-petroleum-darker)',
        corporate: 'var(--color-corporate)',
        'corporate-dark': 'var(--color-corporate-dark)',
        'corporate-darker': 'var(--color-corporate-darker)',
        'corporate-deep': 'var(--color-corporate-deep)',
