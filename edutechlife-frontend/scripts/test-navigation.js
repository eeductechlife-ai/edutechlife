...
const mapViewToRoute = (view) => {
  const routeMap = {
    ...
    'smartboard': '/ingenia',
    'smartboard-estadisticas': '/ingenia/estadisticas',
    'smartboard-progreso': '/ingenia/estadisticas',
    'admin': '/admin',
    'sign-up': '/sign-up',
    'login': '/',
    ...
    'dashboard': '/dashboard',
    'misiones': '/ingenia?tab=misiones',
    'materias': '/ingenia?tab=materias',
    'estadisticas': '/ingenia/estadisticas',
  };
...
const testCases = [
  ...
  { view: 'smartboard', expected: '/ingenia' },
  { view: 'smartboard-estadisticas', expected: '/ingenia/estadisticas' },
  { view: 'consultoria-b2b', expected: '/consultoria-b2b' },
  { view: 'automation', expected: '/automation' },
  { view: 'misiones', expected: '/ingenia?tab=misiones' },
  { view: 'materias', expected: '/ingenia?tab=materias' },
];
...
const routeTests = [
  ...
  { route: '/ingenia', valid: true },
  { route: '/ingenia/estadisticas', valid: true },
