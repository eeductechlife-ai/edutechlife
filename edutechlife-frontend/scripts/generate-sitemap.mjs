...
const ROUTES = [
  ...
  { loc: '/conoce-ingenia', priority: 0.8, changefreq: 'monthly' },
  { loc: '/ingenia', priority: 0.9, changefreq: 'weekly' },
  { loc: '/ingenia/padres', priority: 0.7, changefreq: 'monthly' },
  { loc: '/sign-up/ialab', priority: 0.5, changefreq: 'monthly' },
  { loc: '/sign-up/ingenia', priority: 0.5, changefreq: 'monthly' },
