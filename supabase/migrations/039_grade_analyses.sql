-- ============================================================================
-- Migration 039 — grade_analyses (GradeScanner)
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'grade_analyses' AND policyname = 'Students read own analyses') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'grade_analyses' AND policyname = 'Students insert own analyses') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'grade_analyses' AND policyname = 'Students delete own analyses') THEN
